...
The iScripts GoStores2.4 enables any web master to offer domain 
...
2.0 Requirements
******************************************************************************************
The iScripts GoStores2.4 is developed in PHP and the database is
...
4.1) To send automatic invoicing to the customers, automatic domain renewal
	...
	d)  wget -q -O /dev/null "http://www.yoursitename/admin/crongeneration/billnotification" > /dev/null 2>&1

	e)  wget -q -O /dev/null "http://www.yoursitename/admin/crongeneration/disableExpiredDomains" > /dev/null 2>&1
...
5.4) Run the URL http://www.yoursitename/project/upgrade2.1/ and follow the instructions shown on screen. 


*******************************************************************************
6.0 Upgrading from version 2.1 iScripts GoStores Platform
*******************************************************************************
...
6.1) Download the new version of iScripts GoStores.


6.2) Take backup of the existing all files and database.


6.3) After replacing all your current files with the new ones, copy back the following files and folders from your backup
...
6.4) Run the URL http://www.yoursitename/project/upgrade2.2/ and follow the instructions shown on screen. 


*******************************************************************************
7.0 Upgrading from version 2.2 iScripts GoStores Platform
*******************************************************************************
...
7.1) Download the new version of iScripts GoStores.


7.2) Take backup of the existing all files and database.


7.3) After replacing all your current files with the new ones, copy back the following files and folders from your backup
...
7.4) Run the URL http://www.yoursitename/project/upgrade2.3/ and follow the instructions shown on screen. 


*******************************************************************************
8.0 Upgrading from version 2.3 iScripts GoStores Platform
*******************************************************************************
...
8.1) Download the new version of iScripts GoStores.


8.2) Take backup of the existing all files and database.


8.3) After replacing all your current files with the new ones, copy back the following files and folders from your backup
...
8.4) Run the URL http://www.yoursitename/project/upgrade2.4/ and follow the instructions shown on screen. 
