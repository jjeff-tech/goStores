	...
	if ( !file_exists( $folderPath ) )
	{
		...
		if ( isset( $Config['ChmodOnFolderCreate'] ) && !$Config['ChmodOnFolderCreate'] )
		{
			mkdir( $folderPath ) ;
                        ...
                        $folderPathFTPArray = explode("uploads/",$folderPath);
                        $folderPathFTP       = $folderPathFTPArray[1];
                        $folderPathFTP       = "uploads/".$folderPathFTP;
                        createFTPFolderEditor($folderPathFTP);
		}
		else
		{
			$permissions = 0777 ;
...
function createFTPFolderEditor($dir) {
            ...
            $dir_cdn = CDN_FTP_BASE_PATH.$dir;
            createCDNFolderEditor($dir_cdn);
    }


    function createCDNFolderEditor($dir) {
