...
// +----------------------------------------------------------------------+
        ...
        include("./languages/".$_SP_language."/news.php");
        $conn = getConnection();
        $page = "news";
?>
<?php include("../includes/docheader.php"); ?>

<title><?php echo HEADING_NEWS_DETAILS ?></title>
...
<!--
                ...
                var flag = false;
                        ...
                        if(flag == true) {
                                                        if(confirm('<?php echo MESSAGE_JS_DELETE_TEXT; ?>')) {
                                                                document.frmNews.postback.value="DA";
        ...
        function deleted(id) {
                ...
                function clickSearch() {
                        document.frmNews.numBegin.value=0;
                        document.frmNews.begin.value=0;
                        document.frmNews.start.value=0;
                        document.frmNews.num.value=0;
                        document.frmNews.method="post";
                        document.frmNews.submit();
                }
-->
