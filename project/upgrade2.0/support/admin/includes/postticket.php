                                                  ...
                                                  <td class="maintext">
                                                                                                      ...
                                                                                                      <div class="content_section_subtitle"><h3><?php echo TEXT_GENERAL_INFO?></h3></div>
																										   ...
																										   <tr>
																												...
																												<td width="76%" align="left">
                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                    <input type="text" name="txtUsername" value="<?php echo stripslashes($_POST['txtUsername']);?>" class="comm_input input_width1a" maxlength="100" size="100" id="txtautoComplete" >
                                                                                                            ...
                                                                                                            <td width="76%" align="left">
                                                                                                               <?php
                                                                                                                     $sql = "select nPriorityValue ,vPriorityDesc  from sptbl_priorities order by nPriorityValue";
                                                                                                                          $rs = executeSelect($sql,$conn);
                                                                                                                        ?>
                                                                                                   <select name="cmbPriority" size="1" class="comm_input input_width1a" id="cmbPriority">
                                                                                                                     <?php
                                                                                             ...
                                                                                             ?>
                                                                                                         ...
                                                                                                         <div class="content_section_subtitle"><h3><?php echo TEXT_TICKET_INFO?></h3></div>
                                                                                                          ...
                                                                                                          <tr>
                                                                                                            <td width="142" align="left" class="fieldnames"><?php echo TEXT_TICKET_TITLE?>&nbsp;<span class="required">*</span></td>
                                                                                                            <td width="6">&nbsp;</td>
                                                                                                            <td width="460" align="left"><input name="txtTcktTitle" type="text" size="70" maxlength="100" class="comm_input input_width1a" value="<?php echo htmlentities($var_title);?>"></td>
                                                                                                          </tr>
                                                                                                          <tr>
                                                                                                           <td colspan="3">&nbsp;</td>
                                                                                                          </tr>
                                                                                                       ...
                                                                                                       <!--   <tr>
                                                                                                          ...
                                                                                                          <tr>
                                                                                                             <td align="left" class="fieldnames"><?php echo TEXT_ATTACH_URL?>&nbsp;</td>
                                                                                                             <td>&nbsp;</td>
                                                                                                             <td width="58%" align="left" class="listing">
                                                                                                                 <?php
