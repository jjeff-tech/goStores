...
//			    unlink("../".$var_LogoURL);  modified roshith on 6-11-06
                ...
                vLookUpValue='" . addslashes($var_LogoURL) . "'
           ...
           if (validateUpdation() == true and $dup_flag==0 and $errorcode=="") {
             ...
             $sql = "Update sptbl_lookup set vLookUpValue='" . addslashes($var_sitetitle) .
             "'  where vLookUpName = 'HelpdeskTitle'";
             executeQuery($sql,$conn);

             $sql = "Update sptbl_lookup set
             vLookUpValue='" . addslashes($var_emailfooter) . "'
             where vLookUpName='Emailfooter'";
             executeQuery($sql,$conn);

             $sql = "Update sptbl_lookup set
             vLookUpValue='" . addslashes($var_emailheader) . "'
...
?>
<form name="frmConfig" method="POST" action="<?php echo($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data">
