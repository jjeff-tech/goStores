...
// +----------------------------------------------------------------------+
      ...
      if ($_POST["postback"] == "U") {
             ...
             $var_oprating = trim($_POST["rdOpRating"]);
				...
				//$sql = "Update sptbl_companies set vChatWelcomeMessage='" . addslashes($var_welcomemsg) ."', vChatCodeSnippet='".addslashes($var_codesnippet)."', vChatOperatorRating='".addslashes($var_oprating)."', vChatIcon ='".addslashes($var_chaticon)."' where nCompId='".$var_companyid."'";
			   $sql = "Update sptbl_companies set vChatWelcomeMessage='" . addslashes($var_welcomemsg) ."', vChatOperatorRating='".addslashes($var_oprating)."', vChatIcon ='".addslashes($var_chaticon)."' where nCompId='".$var_companyid."'";
...
<form name="frmChatConfig" method="POST" action="<?php echo($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data">
