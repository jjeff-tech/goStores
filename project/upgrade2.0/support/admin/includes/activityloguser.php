...
if ($var_search != ""){
	if($var_cmbSearch == "activity") {
			$qryopt .= " AND a.vAction like '" . addslashes($var_search) . "%' " . (($var_cmbUser != "")?(" AND a.nUserId='" . addslashes($var_cmbUser) . "' "):" AND a.nUserId!='0' ");
			
	}elseif($var_cmbSearch == "area") {
			$qryopt .= " AND a.vArea like '" . addslashes($var_search) . "%' " . (($var_cmbUser != "")?(" AND a.nUserId='" . addslashes($var_cmbUser) . "' "):" AND a.nUserId!='0' ");
	}
}
elseif ($var_cmbUser != "") {
		$qryopt .= " AND a.nUserId='" . addslashes($var_cmbUser) . "' ";
}
else {
                     ...
                     <tr>
                        <td width="100%">
                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                        <td valign="top">
                                        <div class="content_search_container" style="background-color:#ffffff; border:0 none; ">
                                                <div class="left rightmargin ">
                                                        <?php echo TEXT_SELECT_USER?>
                                                </div>
                                                <div class="left rightmargin">
                                                        <select name="cmbUser" class="selectstyle">
                                                        <?php echo($lst_users); ?>
                                        ...
                                        <td valign="top">
                                        <div class="content_search_container right" style="background-color:#ffffff; border:0 none; width:300px; ">
                                                <div class="left rightmargin ">
