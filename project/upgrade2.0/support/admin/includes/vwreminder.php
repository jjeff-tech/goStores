...
// +----------------------------------------------------------------------+
	...
	elseif ($_POST["postback"] == "U") {
	  $sql = "Select nRemId from sptbl_reminders where nRemId='" . addslashes($var_id) . "'";	
...
<Div class="content_section_title"><h3><?php echo TEXT_VW_REMINDER ?></h3></Div>
      ...
      <div <?php echo $flag_msg; ?>>   <?php echo $var_message ?> </div></td>
         ...
         <td width="74%" align="left">
         <input name="txtAlert" type="text" id="txtAlert" size="24" maxlength="20" value="<?php echo htmlentities($var_alert); ?>" style="font-size:11px;width:110px" readonly class="comm_input input_width1"> 
