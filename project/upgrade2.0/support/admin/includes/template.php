...
$sql .= "LEFT OUTER JOIN sptbl_staffs sf ON st.nStaffId = sf.nStaffId where  st.vStatus='1' ";
...
if($var_search != ""){
	if($var_cmbSearch == "title"){
			...
			$qryopt .= " AND sf.vLogin  like '" . addslashes($var_search) . "%'";
	}
}
...
<a href="javascript:clickSearch();"><img src="./../languages/<?php echo $_SESSION['sess_language'];?>/images/go.gif" border="0"></a>
                                          ...
                                          <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="list_tbl"  >
                                              <tr align="left"  class="listing">
											  	<th width="4%">&nbsp;</th>
                                                <th width="34%"><?php echo "<b>".TEXT_TITLE."</b>"; ?></th>
                                                <th width="35%"><?php echo "<b>".TEXT_USER."</b>"; ?></th>
                                                <th width="16%"><?php echo "<b>".TEXT_DATE."</b>"; ?></th>
...
?>
                                              ...
                                              <tr align="left"  class="listingmaintext">
											   ...
											   <td><?PHP echo htmlentities(trim_the_string($row["vTemplateTitle"])); ?></td>							
                                                ...
                                                <td width="5%" align="center"><a href="edittemplate.php?id=<?php echo $row["nTemplateId"]; ?>&stylename=STYLETEMPLATES&styleminus=minus19&styleplus=plus19&"><img src="././../images/edit.gif" width="13" height="13" border="0" title="<?php echo TEXT_TITLE_EDIT ?>"></a></td>
                                                <td width="6%" align="center"><a href="javascript:deleted('<?php echo $row["nTemplateId"]; ?>');"><img src="././../images/delete.gif" width="13" height="13" border="0" title="<?php echo TEXT_TITLE_DELETE ?>"></a></td>
                                              </tr>
<?php
$cnt++;
}
