                                    ...
                                    <div <?php echo $flag_msg; ?>><?php echo($var_message); ?></div>
                                          ...
                                          <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="list_tbl" >
                                              <tr align="left"  class="listing">
											    <th width="5%">&nbsp;</td>
                                                <th width="28%" ><?php echo "<b>".TEXT_TITLE."</b>"; ?></th>
                                                <th width="16%"><?php echo "<b>".TEXT_REFNO."</b>"; ?></th>
                                                <th width="35%"><?php echo "<b>".TEXT_STAFF."</b>"; ?></th>
...
?>
                                              ...
                                              <tr align="left"  class="whitebasic">
											   ...
											   <td><?PHP echo htmlentities(trim_the_string($row["vPNTitle"])); ?></td>
                                                ...
                                                <td width="8%" align="center"><a href="editpersonalnotes.php?id=<?php echo $row["nPNId"]; ?>&stylename=STYLEPERSONALNOTES&styleminus=minus16&styleplus=plus16&"><img src="././../images/edit.gif" width="13" height="13" border="0" title="<?php echo TEXT_TITLE_EDIT ?>"></a></td>
                                                <td width="8%" align="center"><a href="javascript:deleted('<?php echo $row["nPNId"]; ?>');"><img src="././../images/delete.gif" width="13" height="13" border="0" title="<?php echo TEXT_TITLE_DELETE ?>"></a></td>
                                              </tr>
<?php
$cnt++;
}
