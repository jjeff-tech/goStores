...
<form name="frmDetail" action="<?php echo   $_SERVER['PHP_SELF']?>" method="post">
                 ...
                 <table width="100%"  border="0" cellspacing="0" cellpadding="5">
                         <tr>
                            <td colspan="3" align="CENTER">							<select name="cmbDepartment" class="comm_input input_width1" onChange="javascript:changeDepartment();">
...
<Div class="content_section_title"><h3><?php echo TEXT_SPAM_TICKETS ?></h3></Div>
