...
<?php
	...
	$sql = "Select nTicketId from sptbl_tickets where vStatus='open'";
	$var_cntopen  = mysql_num_rows(executeSelect($sql,$conn));
	$sql = "Select nTicketId from sptbl_tickets where vStatus='closed'";
	$var_cntclosed  = mysql_num_rows(executeSelect($sql,$conn));
	$sql = "Select nTicketId from sptbl_tickets where vStatus='escalated'";
	$var_cntescalated  = mysql_num_rows(executeSelect($sql,$conn));
	$sql = "Select nTicketId from sptbl_tickets";
	...
	$var_cntfollow  = mysql_num_rows(executeSelect($sql,$conn));
        $sql = "Select DISTINCT t.nTicketId from sptbl_replies r LEFT JOIN sptbl_tickets t ON t.nTicketId = r.nTicketId where r.nHold = '1' ";
			...
			<ul>
				...
				<a href="<?php echo SITE_URL?>admin/addcannedmessage.php?stylename=STYLECHAT&styleminus=minus25&styleplus=plus25&" ><?php echo TEXT_SIDE_ADD_CANNED_MESSAGES ?></a>
                 ...
                 <?php } ?>
                     ...
                     <!--  Profile Preferences-->
		<li class="accordionButton2"><a href="#" onClick="javascript:window.open('./languages/<?php echo $_SP_language ?>/help/index.php','Help','width=680,height=610');"><?php echo TEXT_SIDE_HELP ?></a></li>
