...
$sql = " SELECT kb.nKBID, kb.vKBTitle,kb.vStatus, d.nDeptId,d.vDeptDesc,d.vDeptMail,c.nCompId,c.vCompName, ca.vCatDesc, ca.nCatId ";
...
<div class="content_section">
			<div class="content_section_title">
				<h3><?php echo HEADING_APPROVE_KB_ENTRIES ?></h3>
			</div>
                                        ...
                                        <tr>
											<td width="100%">
												<table width="100%" cellpadding="0" cellspacing="0" border="0">
													...
													<tr>
													    <td width="70%" align="right" class="whitebasic">
													...
													<?php if($var_message != ''){ ?>
													<tr><td align="center" colspan="2" class="msg_success"><b><?php echo($var_message); ?></b></td></tr>
                                                                                                        <?php } ?>
												</table>
											</td>
										</tr>	
									    <tr>
                                          <td class="whitebasic" ><table width="100%"  border="0" cellpadding="2" cellspacing="0" class="list_tbl" >
                                              <tr align="left"  class="listing">
											  	<th width="5%">&nbsp;</th>
                                                <th width="25%" ><?php echo "<b>".TEXT_TITLE."</b>"; ?></th>
                                                <th width="24%"><?php echo "<b>".TEXT_DEPARTMENT."</b>"; ?></th>
                                                <th width="31%"><?php echo "<b>".TEXT_CATEGORY."</b>"; ?></th>
...
?>
                                              ...
                                              <tr align="left"  class="whitebasic">
                                                ...
                                                <td width="8%" align="center"><a href="editkbentry.php?id=<?php echo $row["nKBID"]; ?>&stylename=STYLEKNOWLEDGEBASE&styleminus=minus6&styleplus=plus6&"><img src="././../images/edit.gif" width="13" height="13" border="0" title="<?php echo TEXT_EDIT_ENTRY; ?>"></a></td>
                                                <td width="7%" align="center">
													<?php
														$status = $row["vStatus"];
														if($status == "A"){
															$newstatus = "I";
															$displayimage = "reject.gif";
															$tooltip = TEXT_DISAPPROVE_ENTRY;
														}else{
															$newstatus = "A";
															$displayimage = "approve.gif";
															$tooltip = TEXT_APPROVE_ENTRY;
														}
													
													?>
														<a href="javascript:changestatus('<?php echo $row["nKBID"]; ?>','<?php echo $newstatus; ?>');"><img src="././../images/<?php echo $displayimage?>" width="13" height="13" border="0" title="<?php echo $tooltip; ?>"></a>
												</td>
                                              </tr>
<?php
$cnt++;
                              ...
                              <tr>
                                <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                  <tr align="center" class="listingbtnbar">
                                    <td> 
                                      <input name="btnApproveAll" type="button" class="comm_btn" value="<?php echo BUTTON_TEXT_APPROVE_ALL ?>" onClick="javascript:clickChangeStatus('A');">                                   
									  &nbsp;&nbsp;
									  <input name="btnDisapproveAll" type="button" class="comm_btn" value="<?php echo BUTTON_TEXT_DISAPPROVE_ALL ?>" onClick="javascript:clickChangeStatus('I');"> 
									   </td></tr>
                                </table></td>
                              </tr>
                          </table></td>
