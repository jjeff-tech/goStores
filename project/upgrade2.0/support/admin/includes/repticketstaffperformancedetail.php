...
if ($var_staffcmbid <> 0) {
    $sqlUser = mysql_query("SELECT nStaffId,vStaffname,vLogin FROM sptbl_staffs WHERE nStaffId = '" . addslashes($var_staffcmbid) . "' LIMIT ".$limitstart . ", " .$limitend);
} else {
...
?>
     ...
     <tr>
            ...
            <tr><td colspan="2" align="center">
                 ...
                 do {
                        $pageCount ++;
                    $link = "repstaffperfomance.php?start=$st&end=$end";
                    if($limitstart == $st){
