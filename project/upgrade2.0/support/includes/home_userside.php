...
if(isset($_POST["postback"]) && $_POST["postback"]=='Login'){
		 ...
		 if($AD_AUTHENTICATION == "Y"){
			...
			if(isNotNull($_POST["txtUserID"])){
				...
				@ldap_close($ldap_conn);
				if($error != true){
					$sql  = "SELECT u.nUserId ,u.nCompId, u.vUserName , u.vEmail , u.vLogin , u.vBanned, u.vPassword,u.nCSSId FROM sptbl_users u  ";
	 ...
	 <form name="frmLogin" id="frmLogin" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>"  >
		<div class="loginbox_new">
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0" class="home_login">
                                ...
                                <tr>
                                    <td align="left" valign="top" colspan="3" class="home_text_style1">
                             ...
                             if($errormessage!='') {?>
                                ...
                                <tr>
									  <td align="left" valign="top" colspan="2" class="top_padding">
                                        <a href="#"  onClick="toggleVisibility();" ><?php echo TEXT_FORGOT_PASSWORD;?></a>
                                    </td>
                                    <td align="left" valign="top" width="10%" class="rightpadding">

                                        <input name="btnSubmit" type="submit" class="button" value="<?php echo TEXT_LOGIN;?>"  onClick="return checkLoginForm();" >
							...
							<div id="GetPass" class="home_login_get_pass"  style="display:<?php echo $txtforgot;?>">
								...
								<table width="100%"  border="0" cellspacing="5" cellpadding="0">
								  <tr>
								  	<td colspan="2">
									 <a href="#" class="get_pass_close" onclick="toggleVisibility();">X</a> 
									</td>
								  </tr>
								  
								  <tr>
									<td valign="top" align="left"><div class="left">
                                               <?php echo TEXT_EMAIL ?>
                                            </div></td>
									<td valign="top" align="left">
									<input name="txtUserEmail" id="txtUserEmail" type="text" class="comm_input" style="width:157px;"  value="<?php echo $_POST['txtUserEmail'];?>">
									</td>
								  </tr>
								  <tr>
								  	<td colspan="2"></td>
								  ...
								  <tr>
									<td colspan="2" align="right">
									 <input name="btnGetPassword" type="button" class="comm_btn" style="width:120px;" value="<?php echo TEXT_GET_PASSWORD;?>" onClick="return checkGetPasswordForm();" >
									</td>
								  </tr>
								</table>
			...
			<div class="registerlink">
							<a href="#" onClick="registration();" ><?php echo CLICK_HERE_REGISTER;?></a></div>
			<div class="clear"></div>
		</div>
	      </form>
...
<form name="frmkbSearch" action="userkbsearchresult.php" method="post">
			  ...
			  <tr>
				<td valign="top" align="left" class="homecontent_box_td">
					<div class="homecontent_box_top">
						<div class="homecontent_topsec1">
							<p>
                                                            <?php echo VIEW_TICKETS_HOME_DEF; ?>
							</p>
						</div>
					</div>
					<div class="home_contentftr_btn">
                                            
                                            <input type="button" class="newhome_btn" value="<?php echo CREATE ?>" onClick="window.location.href='<?php echo SITE_URL; ?>postticketbeforeregister.php'">
				...
				<td valign="top" align="left" class="homecontent_box_td">
				<div class="homecontent_box_top">
					<div class="homecontent_topsec2">
							<p>
							<?php echo TEXT_TICKET_STAUS;?>
							</p>
							<div class="form_content_home">
							</div>
						</div>
					</div>
					<table width="100%" cellpadding="0" cellspacing="0" border="0" class="home_login">
						...
						<tr>
						<td align="left" valign="top" colspan="2">
                                                    <input class="widthnew" name="txtEmail" type="text"  id="txtEmail" value="<?php echo htmlentities($txtEmail); ?>" onfocus="clearText(this,'txtEmail');">
						...
						<tr>
						<td align="left" valign="top" colspan="2">
                                                    <input name="txtTicketRef" class="widthnew" type="text" id="txtTicketRef" value="<?php echo htmlentities($txtTicketRef); ?>" onfocus="clearText(this,'txtTicketRefy');">
						...
						<td align="center" valign="top" width="10%" colspan="3">
                         <div class="home_contentftr_btn"> <input name="btnSearch" id="btnSearch" type="submit" class="newhome_btn" value="<?php echo BUTTON_TEXT_SEARCH ?>" onClick="javascript:searchTicket();">                                                    
                          <input type="hidden" name="postback" value="">
						...
						<tr>
							<td colspan="3"> <a href="#" onClick="redr();" ><?php echo TEXT_GET_REF_NO ?></a></td>
						</tr>
				...
				<div class="form_content_home">
								 <input name="txtKbTitleSearch" id="txtKbTitleSearch" type="text" class="comm_input widthnew"  value="<?php echo htmlentities($var_cc);?>" >
            					<input type="hidden" name="txtKbSearchid" id="txtKbSearchid">
				</div>
				<div class="home_btncontainer">
				<div class="home_contentftr_btn">
				<input type="submit" name="btnKbSearch" id="btnKbSearch" value="<?php echo TEXT_GO;?>" class="newhome_btn">
				<div class="clear"></div>
				</div>
				<div class="clear"></div>
				</div>
			  ...
			  <tr>
				<td valign="top" align="left" class="homecontentbox_footer">
                                    <p><?php echo CREATE_NEW_TCKT;?></p>
                                </td>
				<td>&nbsp;</td>
				<td valign="top" align="left" class="homecontentbox_footer">
					<p><?php echo HOME_TICKET_STAUS;?></p>
				</td>
				<td>&nbsp;</td>
				<td valign="top" align="left" class="homecontentbox_footer">
				<p><?php echo HEADER_KB;?></p>
				 </td>
			  </tr>
			</table>
			</form>
