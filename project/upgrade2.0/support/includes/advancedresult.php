...
$qryopt="";
if ($var_refno != "") {
	$qryopt .= " AND t.vRefNo Like '%" . addslashes($var_refno) . "%' ";
}
if ($var_title != "") {
	$qryopt .= " AND t.vTitle Like '%" . addslashes($var_title) . "%' ";
}
if ($var_status != "") {
	$qryopt .= " AND t.vStatus ='" . addslashes($var_status) . "' ";
}
if ($var_priority != "") {
...
*/	
	//$qryopt .= " AND t.vPriority ='" . addslashes($var_prselect) . "' ";
}
if ($var_from != "") {
	...
	$qryopt .= " AND t.dPostDate >='" . addslashes($var_time1) . "' ";
}
if ($var_to != "") {
	...
	$qryopt .= " AND t.dPostDate <='" . addslashes($var_time2) . "' ";
}
...
<script>
<!--
	var refno = '<?php echo addslashes($var_refno); ?>';
	var ttl = '<?php echo  addslashes($var_title); ?>';
	var status = '<?php echo addslashes($var_status); ?>';
	var prio = '<?php echo addslashes($var_priority); ?>';
