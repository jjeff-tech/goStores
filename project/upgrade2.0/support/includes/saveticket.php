...
//				$var_refno=$var_compid."-".$deptid."-".$var_userid."-".$var_insert_id;
				...
				if($vAttachmentfiles !=""){
				   ...
				   if(logActivity()) {
					   $sql = "Insert into sptbl_actionlog(nALId,nUserId,vAction,vArea,nRespId,dDate) Values('','$var_userid','" . addslashes(TEXT_ADDITION) . "','Ticket','" . addslashes($var_ticketid) . "',now())";
//                                           echo $sql."<br>";
