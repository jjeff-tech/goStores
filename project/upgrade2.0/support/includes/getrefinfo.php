...
<br>
    ...
    <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="comm_tbl btm_brdr">
	<tr><td>&nbsp;</td></tr>
         <tr>
       ...
       <div <?php echo $flag_msg; ?>>  <?php echo $message ?> </div></td>
         ...
         <tr>
             <td align="right" width="20%"><?php echo TEXT_EMAIL?>&nbsp;<span class="required">*</span></td>
              <td align="left"><input name="txtEmail" type="text"  maxlength="100" class="comm_input input_width1" value="<?php echo $email;?>" onKeyPress="return refNoPress();"></td>
                                                                                                          </tr>
           <tr>
		   </table>
