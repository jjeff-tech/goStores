...
<form name="frmShowKb" action="<?php echo   $_SERVER['PHP_SELF']?>" method="post">
                                    ...
                                    <td align="right"><table width="100%" border="0" cellspacing="0" cellpadding="0">
						                ...
						                <td><table width="100%"  border="0" cellpadding="0" cellspacing="0" class="dotedhoriznline">
						                    ...
						                    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
											  ...
											  <tr align="left" >
                                                <td colspan="5" class="listingmaintext" align=center><b><?php echo htmlentities($var_title); ?></b></td>
                                              </tr>
...
$navigate = pageBrowser($totalrows,10,1,"&mt=y&deptid=$var_deptpid&tckttitle=" . urlencode($var_title) . "&stylename=POSTTICKETS&styleminus=twominus&styleplus=twoplus&",$var_numBegin,$var_start,$var_begin,$var_num);
...
?>
                                              ...
                                              <tr align="left"  class="listingmainboldtext">
											     ...
											     <td colspan=2>
											         ...
											         <b><?PHP echo htmlentities(stripslashes($row["vKBTitle"])); ?></b>
                                                </td>
...
?>
                                              <tr align="left"  class="listingmaintext">
                                                <td width="30%"><?php echo($navigate[1] ."&nbsp;".TEXT_OF."&nbsp;".$totalrows."&nbsp;" .TEXT_RESULTS ); ?></td>
