...
$keyCondition .= ")";
 ...
 $sql = "select DISTINCT nKBID,vKBTitle,tKBDesc from sptbl_kb ".$keyCondition . " LIMIT 0, 10";
...
<table cellpadding="5" cellspacing="1" border="0" class="" style="background-color:#cfcfcf;" width="100%">
    ...
    <?php
		while($row=mysql_fetch_array($result_kbtitle)){
               $viewkbentry_seo_link = SITE_URL . "viewuserkbsearchresult/".stripslashes($row['vKBTitle']). "/".$row["nKBID"]."/KNOWLEDGEBASE";
