<?php
include "languages/".$_SP_language."/newsbox.php";
?>
...
function showDetails(i) {
	document.frmShowNews123.id.value=i;
	document.frmShowNews123.submit();
}
...
<?php
 ...
 $sql = "SELECT nNewsId,vTitle   FROM `sptbl_news` where  dVaildDate >= CURDATE() and (vType='A' or vType='U')  order by dPostdate";
