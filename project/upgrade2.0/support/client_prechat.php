<?php
   ...
   /*end*/
   if ( ( $_POST["postback"] == 'S' ) || ( $_POST["postback"] == 'T' ) ) {
...
// 'zeros' added for 5 digit ticket no
   ...
   $sql_dpt = "SELECT d.nDeptId, d.vDeptDesc FROM sptbl_depts d  ORDER BY d.vDeptDesc";
...
<html>
 ...
 <body bgcolor="#EDEBEB" >
  <table width="100%" height="100%" border="0" class="div_all">
   ...
   <tr  >
    <td ><form id="frmPreChat" name="frmPreChat" method="post" action="<?php echo($_SERVER['PHP_SELF']); ?>">
	 <table width="100%"  border="0" cellpadding="0" cellspacing="10">
	  <tr >
       <td colspan="2"><b><?php echo TEXT_HEADER_INFORMATION; ?></b></td>
      </tr>
	  <tr>
       <td align="center">&nbsp;<font style="color:#FF0000; font-size:12px"><?php if ( $messagetext != '' ) echo $messagetext;?></font></td>
      </tr>
	  <tr>
