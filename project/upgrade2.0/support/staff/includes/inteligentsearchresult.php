...
$qryopt="";
$flag_qry = false;
$txtinteligentsearch = $_POST['txtinteligentsearch'];
...
if($txtinteligentsearch !="" && $_POST['btninteligentsearch']){
	...
	$flag_qry = true;
	//$var_operator = "=";
       // $qryopt .=  $var_logical . "  d.nCompId" . $var_operator . "'" . addslashes($txtinteligentsearch) . "' ";
        $var_operator = " LIKE ";
        
      //  $qryopt .=  $var_logical . "  d.vDeptDesc" . $var_operator . "'" . addslashes($txtinteligentsearch) . "' ";
        $qryopt .=  "  d.vDeptDesc" . $var_operator . "'%" . addslashes($txtinteligentsearch) . "%' ";
        $var_operator = " LIKE ";
        $qryopt .= $var_logical . "  t.vStatus" . $var_operator . "'%" . addslashes($txtinteligentsearch) . "%' ";
        $qryopt .= $var_logical . "  s.vStaffname" . $var_operator . "'%" . addslashes($txtinteligentsearch) . "%' ";
        $qryopt .= $var_logical . "  t.vUserName" . $var_operator . "'%" . addslashes($txtinteligentsearch) . "%' ";
        $qryopt .=  $var_logical . "  t.vRefNo" . $var_operator ."'%" . addslashes($txtinteligentsearch) . "%' ";
        $qryopt .= $var_logical . " t.vTitle" . $var_operator . "'%" . addslashes($txtinteligentsearch) . "%' ";
        $qryopt .= $var_logical . " u.vEmail" . $var_operator . "'%" . addslashes($txtinteligentsearch) . "%' ";
        //$var_operator = "=";
        $qryopt .=  $var_logical . "  l.vLabelname" . $var_operator . "'" . addslashes($txtinteligentsearch) . "' ";
        $qryopt .= $var_logical . " t.tQuestion" . $var_operator . "'%" . addslashes($txtinteligentsearch) . "%' ";
       // echo $qryopt;exit;
}
else{
