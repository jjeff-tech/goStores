<?php
  ...
  mysql_free_result($rs);
		...
		foreach($status_arr as $key=>$value) {
		  $sql=" select count(*) as cnt from sptbl_tickets where  dPostDate like '$datefilter%' and nDeptid in($lst_dept) and vStatus='".addslashes($value)."'";
		  $rs_cnt = executeSelect($sql,$conn);
		  $row = mysql_fetch_array($rs_cnt);
				  ...
				  <table border="0" cellpadding="0" cellspacing="0"  >
						  ...
						  <tr align="left" >
						    ...
						    <tr>
						                 ...
						                 <table border="0" cellpadding="0" cellspacing="0"  >
										 		<tr class="listingmaintext"><td width="10" valign="bootom" width="30"><?php echo $ht ?>%</td></tr>
											   <tr>
											       <?php if($ht==0){ ?>
