...
?>
											  ...
											  <td align="center" valign="top" width="3%">
													<input type="checkbox" name="chkDeleteTickets[]" id="chkDeleteTickets<?php echo($cntr);?>" value="<?php echo($row["nTicketId"]); ?>">
													 ...
													 case "vPriority":
                                                                                                        for($j=0;$j < count($fld_prio);$j++) {
                                                                                                         ...
                                                                                                         break;
													 case "dPostDate":
															 echo "<td width='12%' align=left ><a href=\"viewticket.php?limitval=$limitstart&mt=y&tk=" . $row["nTicketId"] . "&us=" . $row["nUserId"] . "&stylename=$var_stylename&styleminus=$var_styleminus&styleplus=$var_styleplus\" class='listing'>" . date("m-d-Y",strtotime($row[($fld_arr[$i][0])])) . "</a></td>";
															 break;
													 case "nLockStatus":
													...
													case "vRefNo":
															...
															break;
													case "vTitle":
															  echo "<td width='48%' style=\"word-break:break-all;\" align=left><div style=\"overflow:auto;\"><span  id=\"link".$count."\" ><a href=\"viewticket.php?limitval=$limitstart&mt=y&tk=" . $row["nTicketId"] . "&us=" . $row["nUserId"] . "&stylename=$var_stylename&styleminus=$var_styleminus&styleplus=$var_styleplus\" class='listing'>" .  htmlentities($row[($fld_arr[$i][0])]) . "</span><br>".$arrayDeptName[$row["nDeptId"]]."</a></div></td>";
															break;
													  default:
															  echo "<td width='10%' align=left><a href=\"viewticket.php?limitval=$limitstart&mt=y&tk=" . $row["nTicketId"] . "&us=" . $row["nUserId"] . "&stylename=$var_stylename&styleminus=$var_styleminus&styleplus=$var_styleplus\" class='listing'>" .  htmlentities($row[($fld_arr[$i][0])]) . "</a></td>";
															break;
											 }
											  ?>
											<?php
...
<div class="content_search_container">
						...
						<div class="left rightmargin">
						<select name="cmbAction" class="comm_input input_width3">
						...
						<div class="left rightmargin">
						 <select name="cmbStatus" class="comm_input input_width3" >
						...
						<div class="left rightmargin">
						 <select name="cmbLabel" class="comm_input input_width3">
						...
						<div class="left"><a href="javascript:clickUpdate(0);"   style="text-decoration:none;"><img src='./../languages/<?php echo $_SESSION['sess_language'];?>/images/go.gif' border=0></a></div>
