...
//	if ($_POST["postback"] == "") {
           $sql = "Select vuseremail,nSpamTicketId,nDeptId,vTitle,tQuestion,dPostDate from sptbl_spam_tickets where nSpamTicketId='".addslashes($spamticketid)."' ";
...
?>
<form name="frmSpamEmails" method="POST" action="<?php echo($_SERVER['PHP_SELF']); ?>">
	...
	<h3><?php echo TICKET_SPAM_DETAILS ?></h3>
     ...
     <td>
		<div style="overflow:auto">
         ...
         <td width="61%" align="left" class=maintext>
          <?php echo htmlentities(stripslashes($row['tQuestion'])); ?>
         </td>
         </tr>
