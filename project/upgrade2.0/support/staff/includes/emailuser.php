...
//		echo $sql;
		...
		if($flag == true){
			if($_POST['rdCreateTicket']=="YES"){ 
				...
				$var_deptid=addslashes($_POST['cmbDept']);
				...
				$sql = "Select * from sptbl_users where vEmail='" . addslashes($var_email_to) . "'";
				$exc=mysql_query($sql);
	...
	//			   $var_refno=$company."-".$deptid."-".$var_userid."-".$var_insert_id;
				   ...
				   executeQuery($sql_update_ticket,$conn);
						...
						$sql1 .= " VALUES('','".addslashes($company)."', '".addslashes($name)."','".addslashes($email)."','".addslashes($loginname)."','".addslashes(md5($password))."',now(),'0','0')";
                            ...
                            <tr>
                              <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                  <tr align="center"  class="whitebasic">
                                    ...
                                    <td width="16%"><input name="btCancel" type="reset" class="comm_btn" value="<?php echo BUTTON_TEXT_CANCEL; ?>" onClick="return clearForm(this.form);"></td>
                                    <td width="12%">&nbsp;</td>
                                    <td width="20%">
