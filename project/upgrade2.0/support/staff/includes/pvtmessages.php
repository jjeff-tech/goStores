...
if($var_search != ""){
        if($var_cmbSearch == "fromname"){
                        ...
                        $qryopt .= " AND PM.vPMTitle like '" . addslashes($var_search) . "%'";
        }elseif($var_cmbSearch == "toname"){
                        $qryopt .= " AND S1.vStaffName like '" . addslashes($var_search) . "%'";
        }
}
...
<form name="frmPvtMessage" action="<?php echo   $_SERVER['PHP_SELF']?>" method="post">
...
<div class="content_search_container">
                      ...
                      <option value="title" <?php echo(($var_cmbSearch == "title")?"Selected":""); ?>><?php echo TEXT_TITLE ?></option>
						...
						<div class="left">
						<input type="text" name="txtSearch" value="<?php echo(htmlentities($var_search)); ?>" class="comm_input input_width1" onKeyPress="if(window.event.keyCode == '13'){ return false; }" >
						&nbsp;&nbsp;</div>
...
?>
											...
											<input name="btnDelete" type="button" class="comm_btn" value="<?php echo BUTTON_TEXT_DELETE; ?>" onClick="javascript:clickDelete();">
											</td>
											 </tr>
