                                                  ...
                                                  <td class="maintext">
                                                                                                        <table width="100%"  border="0" align="center">
                                                                                                         ...
                                                                                                         <div class="content_section_subtitle"><h3><?php echo TEXT_GENERAL_INFO?></h3></div>
                                                                                                           ...
                                                                                                           <table width="100%">
																										   <tr>
																												<td width="19%" align="left" class="listingmaintext"><?php echo POST_NAME?>&nbsp;<span class="required">*</span></td>
																												<td width="4%"><input type="hidden" name="cmbUser" value="" class="comm_input input_width1" id="txtUserid"  ></td>
                                                                                                   ...
                                                                                                   <select name="cmbDept" size="1" class="comm_input input_width1" id="cmbDept" style="width:250px;">&nbsp; </select>
                                                                                      </td>
                                                                                             ...
                                                                                             ?>
                                                                                                          ...
                                                                                                          <tr>
                                                                                                            ...
                                                                                                            <td width="0">&nbsp;</td>
                                                                                                            <td width="0" align="left"><input name="txtTcktTitle" type="text" size="70" maxlength="100" class="comm_input input_width1" value="<?php echo htmlentities($var_title);?>" style="width:550px"></td>
                                                                                                          </tr>
                                                                                                          <tr>
                                                                                                           <td colspan="3">&nbsp;</td>
                                                                                                          </tr>
                                                                                                        ...
                                                                                                        <!--<textarea name="txtMatter" cols="50" rows="12" id="txtMatter" class="textarea" style="width:550px;"><?php //echo htmlentities($var_desc); ?></textarea>-->
                                                                                                         ...
                                                                                                         <!-- <tr>
                                                                                                          ...
                                                                                                          <tr>
                                                                                                             <td align="left" class="listingmaintext"><?php echo TEXT_ATTACH_URL?>&nbsp;</td>
                                                                                                             <td>&nbsp;</td>
                                                                                                             <td width="40%" align="left" class="listingmaintext">
                                                                                                                  <?php
                                                                                                          ...
                                                                                                          <?php
                                                                                                           ...
                                                                                                           ?>
                                                                                                                             <tr><td colspan=4>
                                                                                                                             <table width='80%' border="0" align="center" class="sub_content_tbl">
                                                                                                           <?php
                            ...
                            <tr>
                              <td><table width="100%"  border="0" cellpadding="0" cellspacing="0" class="maintext">
                                  <tr align="center" class="pagecolor">
                                    <td width="34%">&nbsp;</td>
                                    <td width="16%"><input name="btnSubmit" type="button" class="comm_btn" value="<?php echo BUTTON_TEXT_SUBMIT?>" onClick="javascript:addticket();"></td>
