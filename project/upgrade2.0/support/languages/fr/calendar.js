...
"Pour consulter toute dernière version: http://dynarch.com/mishoo/calendar.epl\n" +
"Distribué sous GNU LGPL.  See http://gnu.org/licenses/lgpl.html for details." +
"\n\n" +
"date de la sélection:\n" +
"- Utilisez le \xab, \xbb boutons pour sélectionner l'année\n" +
"- Utilisez le " + String.fromCharCode(0x2039) + ", " + String.fromCharCode(0x203a) + "pour selectionner les mois\n" +
"- Tenez le bouton de la souris sur un des boutons ci-dessus pour accélérer la sélection.";
Calendar._TT["ABOUT_TIME"] = "\n\n" +
"sélection du temps:\n" +
"- Cliquez sur l'une des pièces du temps de l'augmenter\n" +
"- ou Maj-clic pour le diminuer\n" +
"- ou cliquez et glissez pour accélérer la sélection.";
...
Calendar._TT["NEXT_YEAR"] = "L'année prochaine (maintenir pour menu)";
