            ...
            switch (trim(strtolower($content_type['value']))) {
                ...
                case 'message/rfc822':
                   // $obj = &new MIMEDECODE($body); //
                    $obj = new MIMEDECODE($body);  // Php 5.4 fix by Anoop See below
...
//echo "\n Printing Content type : ".$main_content_type;
...
//echo "\n*********************************************************";
//echo "\n Printing email content after switch case".$msg."\n"; 
