	...
	<script type="text/javascript" src="ckeditor/ckeditor.js"></script>
	 ...
	 $(document).ready(function(){
		...
		CKEDITOR.replace( 'editor1',
        {
            ...
            filebrowserBrowseUrl : 'http://localhost/demos/ckeditor/ckeditor/ckfinder/ckfinder.html',
            filebrowserImageBrowseUrl : 'http://localhost/demos/ckeditor/ckeditor/ckfinder/ckfinder.html?Type=Images',
            filebrowserUploadUrl : 'http://localhost/demos/ckeditor/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files',
            filebrowserImageUploadUrl : 'http://localhost/demos/ckeditor/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images'
            });
