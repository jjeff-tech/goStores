                                                    ...
                                                    <FIELDSET>
                                                        ...
                                                        <table width=85% border=0 cellpadding="2" cellspacing="2" class=maintext>
                                                            <tr>
                                                                ...
                                                                <td width="70%" align=left>
                                                                    <input type="text" name="txtDBServerName" id="txtDBServerName" value="<?php echo trim($user_data['txtDBServerName']) <> "" ? htmlentities($user_data['txtDBServerName']) : "localhost"; ?>" /> <img src="css/Help.png" width="20" height="20" title="Database server name,eg:localhost"></td>
                                                                </td>
                                                            </tr>
                                                            <tr>
