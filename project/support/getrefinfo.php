...
// +----------------------------------------------------------------------+
    ...
    require_once("./includes/applicationheader.php");
        include "languages/".$_SP_language."/getrefinfo.php";
        $conn = getConnection();
        $page = 'getrefinfo';
		$sql = "Select vLookUpName,vLookUpValue from sptbl_lookup WHERE vLookUpName IN('LangChoice',
                                'DefaultLang','HelpdeskTitle','Logourl','logactivity')";
...
<title><?php echo HEADER_REFERENCE_NUMBER;?></title>
	...
	<div class="content_column_big">
		<!-- admin header -->
			...
			<!--  end admin header -->
			 <!-- %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Detail Section %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% -->
                 <?php
                          include("./includes/getrefinfo.php");
                  ?>
          <!-- %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% End Detail Section %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% -->
	</div>
