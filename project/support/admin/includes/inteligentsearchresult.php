...
$sql = "Select t.nTicketId,t.nDeptId,d.vDeptDesc,t.vRefNo,t.nUserId,t.vUserName,t.vTitle,t.tQuestion,t.vPriority,
		...
		sptbl_tickets t inner join sptbl_depts d on t.nDeptId = d.nDeptId
                inner join  sptbl_companies cmp on cmp.nCompId = d.nCompId
...
if($txtinteligentsearch !="") {
    ...
    $var_operator = " LIKE ";
    $qryopt .=   "  cmp.vCompName" . $var_operator . "'%" . mysql_real_escape_string($txtinteligentsearch) . "%' ";
...
<div class="content_section">
    <form name="frmDetail" action="<?php echo($_SERVER["REQUEST_URI"]); ?>" method="post">
        ...
        <div class="content_section_title">
            <h4>
                <?php echo HEADING_ADVANCED_RESULT ?>
            </h4>
        ...
        <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="list_tbl">
            ...
            <tr align="left"  class="whitebasic">
                ...
                $cnt += 2;
                ?>
                <th width="15%"><?php echo "<b>".TEXT_DUE."</b>";?></th>
