...
if($var_search != "") {
    if($var_cmbSearch == "fromname") {
        $qryopt .= " WHERE S.vStaffName like '" . mysql_real_escape_string($var_search) . "%'";
    }elseif($var_cmbSearch == "toname") {
        $qryopt .= " WHERE S1.vStaffName like '" . mysql_real_escape_string($var_search) . "%'";
    }elseif($var_cmbSearch == "title") {
        $qryopt .= " WHERE PM.vPMTitle like '" . mysql_real_escape_string($var_search) . "%'";
    }
}
                                        ...
                                        <td class="whitebasic" >
                                            ...
                                            <table width="100%"  border="0" cellpadding="2" cellspacing="0" class="list_tbl" >
                                                <tr align="left"  class="listing">
                                                    ...
                                                    <th width="13%"><?php echo "<b>".TEXT_STATUS."</b>";
                                                        ; ?></td>
