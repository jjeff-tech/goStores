                                    ...
                                    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0" class="whitebasic">
                                            <tr>
                                                <td align="right"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="bodycolor" ><table width="100%"  border="0" cellpadding="0" cellspacing="1"  >
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <table border=0 width="100%">
                                                                                <tr>
                                                                                    <td align=right class="whitebasic" style="padding:10px 25px 0 0; "><?php echo TXT_SELECT_STAFF; ?></td>
