...
function adminLoggedIn(){
   //print_r($_SESSION);exit;
                if((isset($_SESSION["sess_staffname"]) and $_SESSION["sess_staffname"]!= "") or (isset($_SESSION["sess_isadmin"]) and $_SESSION["sess_isadmin"]!= 0)){
                       return true;
                }else{
                       return false;
                }
...
function staffLoggedIn(){
		if((isset($_SESSION["sess_staffname"]) and $_SESSION["sess_staffname"]!= "") or (isset($_SESSION["sess_isstaff"]) and ($_SESSION["sess_isstaff"]== 1))){
			return true;
		}else{
			return false;
		}
