...
if ($var_search != "") {
    if ($var_cmbSearch == "fromname") {
        $qryopt .= " WHERE S.vStaffName like '" . mysql_real_escape_string($var_search) . "%'" . (($var_mt == "y")?(" AND R.nStaffId='$var_staffid' "):"");
    }elseif ($var_cmbSearch == "title") {
        $qryopt .= " WHERE R.vRemTitle like '" . mysql_real_escape_string($var_search) . "%'" . (($var_mt == "y")?(" AND R.nStaffId='$var_staffid' "):"");
    }
}
elseif ($var_mt == "y") {
