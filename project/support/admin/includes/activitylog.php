...
if ($var_search != "") {
    if($var_cmbSearch == "activity") {
        $qryopt .= " AND a.vAction like '" . mysql_real_escape_string($var_search) . "%' " . (($var_cmbStaff != "")?(" AND a.nStaffId='" . mysql_real_escape_string($var_cmbStaff) . "' "):"  AND a.nStaffId!='0' ");

    }elseif($var_cmbSearch == "area") {
        $qryopt .= " AND a.vArea like '" . mysql_real_escape_string($var_search) . "%' " . (($var_cmbStaff != "")?(" AND a.nStaffId='" . mysql_real_escape_string($var_cmbStaff) . "' "):" AND a.nStaffId!='0' ");
    }
}
elseif ($var_cmbStaff != "") {
    $qryopt .= " AND a.nStaffId='" . mysql_real_escape_string($var_cmbStaff) . "' ";
}
else {
                                        ...
                                        <td width="100%">
                                            ...
                                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                ...
                                                <tr class="whitebasic">
                                                    ...
                                                    <td align="left">
                                                        <div class="content_search_container" style="background-color:#ffffff; width:510px;">
                                                            ...
                                                            <div class="left rightmargin">
                                                                <select name="cmbStaff" class="selectstyle" onchange="javascript:submitForm();" style="height:29px!important; float:left; ">
                                                                    <?php echo($lst_staff); ?>
                                                    ...
                                                    <td align="right">
                                                        <div class="content_search_container right" style="background-color:#ffffff; width:427px; ">
                                                            <div class="left rightmargin topmargin">
                                    ...
                                    <tr>
                                        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                                <tr align="center" class="listingbtnbar">
                                                    <td>
                                                        <input name="btnCancel" type="button" class="comm_btn_greyad" value="<?php echo BUTTON_TEXT_RESET; ?>" onClick="javascript:clickCancel();">                                    </td></tr>
                                            </table></td>
                                    </tr>
                                </table></td>
                            <td width="1" ><img src="./../images/spacerr.gif" width="1" height="1"></td>
