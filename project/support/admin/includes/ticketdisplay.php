									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                           ...
                                           <tr align="left"  class="listingmaintext">
												<td colspan="4" width="100%" style="word-break:break-all; ">
													<br><b>Title : <?php echo htmlentities($row["vTitle"]); ?></b><br>&nbsp;
												</td>
									  </tr>	
                                            <tr>
										...
										<tr>
												<td colspan="4">
													<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="attachband">
														<tr align="center">
														  <td colspan="4"><?php 
															  echo("<a href=\"javascript:var lg=window.open('../attachments/" . mysql_real_escape_string($row["vAttachUrl"]) . "');\">". htmlentities($row["vAttachReference"]) . "</a>");
...
?>
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
												...
												<td colspan="4">
													<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="blackbg">
														...
														?>
														  ...
														  <td width="14%" align="center"><a href="replies.php?rp=r&tk=<?php echo($var_ticketid); ?>&rid=<?php echo($row["nReplyId"]); ?>&&stylename=<?php echo($var_stylename); ?>&styleminus=<?php echo($var_styleminus); ?>&styleplus=<?php echo($var_styleplus); ?>&" class="listing">reply</a></td>
														  <td width="18%" align="center"><a href="replies.php?rp=q&tk=<?php echo($var_ticketid); ?>&rid=<?php echo($row["nReplyId"]); ?>&&stylename=<?php echo($var_stylename); ?>&styleminus=<?php echo($var_styleminus); ?>&styleplus=<?php echo($var_styleplus); ?>&" class="listing">quote &amp; reply</a> </td>
											...
											<tr><td colspan=4  style="word-break:break-all;"><?php echo nl2br(htmlentities($row["tPvtMessage"])); ?></td></tr>					
											 <?php
													...
													<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="attachband">
														<tr align="center">
														  <td colspan="4"  style="word-break:break-all;"><?php 
															  echo("<a href=\"javascript:var lg=window.open('../attachments/" . mysql_real_escape_string($row["vAttachUrl"]) . "');\" class=attachband>". htmlentities($row["vAttachReference"]) . "</a>");
															  while($row = mysql_fetch_array($rs)) {
