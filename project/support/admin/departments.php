...
// +----------------------------------------------------------------------+
        ...
        include("./languages/".$_SP_language."/departments.php");
        $conn = getConnection();

?>
<?php include("../includes/docheader.php"); ?>

<title><?php echo HEADING_DEPARTMENT_DETAILS ?></title>
                ...
                var flag = false;
                        ...
                        if(flag == true) {
                                ...
                                document.frmDetail.submit();
                                                        ...
                                                        alert('<?php echo NO_DEPT_SELECTED; ?>');
                                                }
        }
...
<!--  Top Ends  -->
    ...
    <?php
		...
		<div class="content_column_big">
                  ...
                  <!-- Detail Section -->
                  <?php
                          include("./includes/departments.php");
                  ?>
		          <!-- End Detail section -->
