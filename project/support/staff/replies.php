...
if ($_POST["postback"] == "BA") {  //back
    $location=$_SESSION["sess_backreplyurl"];
...
<script language="javascript" type="text/javascript">
    ...
    function changetemplate(){
        ...
        document.frmReplies.action="<?php echo   basename($_SERVER['PHP_SELF'])?>";
...
*/
        var strFCKEditorText =  CKEDITOR.instances['txtRpMatter'].getData();
        if(strFCKEditorText==""){
