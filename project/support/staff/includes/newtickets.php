...
$sql = "SELECT t.*,rp.nStaffId,rp.nUserId AS rpuserid FROM sptbl_tickets t
        LEFT JOIN sptbl_replies rp on (rp.dDate=t.dLastAttempted and rp.nTicketId=t.nTicketId)
        WHERE t.vDelStatus='0' AND t.vStatus='open' AND t.nLabelId=0";
$qryopt="";
            ...
            <tr>
                <td class="whitebasic" >
                    ...
                    <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="list_tbl" >
                        <?php
                        if($_POST["del"] == "DM" or $_POST["del"] == "UP" or $_POST["labelup"] == "LABELUP" || $message !="" or $_POST["del"] == "MS" or $_POST["del"] == "MERGE" ) {
                        ...
                        <tr align="left">
                            ...
                            <th style="text-decoration:none;">
                                <?php echo "<a href='?val=".$fld_arr[$cnt][0]."&sorttype=".$var_sorttype."&tp=".$var_type."&cmbDepartment=".$var_deptid."&numBegin=$var_numBegin&start=$var_start&begin=$var_begin&num=$var_num&mt=y&stylename=$var_stylename&styleminus=$var_styleminus&styleplus=$var_styleplus'>".constant($fld_arr[$cnt][1])."</a>&nbsp;&nbsp;".$img_path; ?>
                            </th>
                                <?php
                                $cnt++;
                            }
...
/////
                        ...
                        while($row = mysql_fetch_assoc($rs)) { //echo '<pre>'; print_r($row['merged_from']); echo '</pre>';
                                ...
                                for($i=0;$i < count($fld_arr);$i++) {
                                    switch($fld_arr[$i][0]) {
                                        case "vPriority":
                                            ...
                                            break;
                                        case "dPostDate":
                                            echo "<td width='13%'><a href=\"viewticket.php?limitval=$limitstart&mt=y&tk=" . $row["nTicketId"] . "&us=" . $row["nUserId"] . "&stylename=$var_stylename&styleminus=$var_styleminus&styleplus=$var_styleplus\" class='listing'>" . date("m/d/Y  H:i:s",strtotime($row[($fld_arr[$i][0])])) . "</a></td>";
                                            break;
                                        case "nLockStatus":
                                        ...
                                        //echo "<td width='1%'  style=\"word-break:break-all;\" align=center><span  id=\"link".$count."\"  onMouseOver=\"displayAd($count," . $row["nTicketId"] . ");\" onMouseOut=\"hideAd();\" ><a href=\"viewticket.php?mt=y&tk=" . $row["nTicketId"] . "&us=" . $row["nUserId"] . "&stylename=$var_stylename&styleminus=$var_styleminus&styleplus=$var_styleplus\" class='listing'><img src='./../images/ticketdetails.gif' border=0></span></a></td>";
                                            ...
                                            break;
                                        case "vTitle":
                                            echo "<td width=37% style=\"word-break:break-all;\">
                                                    <div style=\"overflow:auto;\"><span style=\"width:100%;height:100%;\"  id=\"link".$count."\" >
                                                        <a href=\"viewticket.php?limitval=$limitstart&mt=y&tk=" . $row["nTicketId"] . "&us=" . $row["nUserId"] . "&stylename=$var_stylename&styleminus=$var_styleminus&styleplus=$var_styleplus\" class='listing'>" .  htmlentities($row[($fld_arr[$i][0])]) ."</span>".$mergedLabel."<br>".$arrayDeptName[$row["nDeptId"]]. "</a>
                                                    </div>
                                                  </td>";
                                            break;
                                        default:
                                            echo "<td width=8%><a href=\"viewticket.php?limitval=$limitstart&mt=y&tk=" . $row["nTicketId"] . "&us=" . $row["nUserId"] . "&stylename=$var_stylename&styleminus=$var_styleminus&styleplus=$var_styleplus\" class='listing'>" .  htmlentities(ucwords($row[($fld_arr[$i][0])])) . "</a></td>";
                                            break;
                                    }
                                    ?>
                                    <?php
                            ...
                            <td colspan="<?php echo $cnt+2; ?>" width="100%">
                                ...
                                <div class="content_search_container">
                                    ...
                                    <div class="left rightmargin">
                                        <select name="cmbAction" class="comm_input" style="width: 160px; margin-right: 20px;" >
                                    ...
                                    <div class="left">
                                        <select name="cmbStatus" class="comm_input" style="width: 155px; margin-right: 15px;" >
                                    ...
                                    <div class="left">
                                        <select name="cmbLabel" class="comm_input" style="width: 155px; margin-right: 15px;">
        ...
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td ><img src="./../images/spacerr.gif" width="1" height="50"></td>
            </tr>
        </table>
