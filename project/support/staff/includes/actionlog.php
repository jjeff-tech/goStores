...
if ($var_search != "") {
    if($var_cmbSearch == "activity") {
        $qryopt .= " and  vAction like '" . mysql_real_escape_string($var_search) . "%' " . (($var_cmbStaff != "")?(" AND nStaffId='" . mysql_real_escape_string($var_cmbStaff) . "' "):"  AND nStaffId!='0' ");

    }elseif($var_cmbSearch == "area") {
        $qryopt .= " and vArea like '" . mysql_real_escape_string($var_search) . "%' " . (($var_cmbStaff != "")?(" AND nStaffId='" . mysql_real_escape_string($var_cmbStaff) . "' "):" AND nStaffId!='0' ");
    }
}
...
?>
<form name="frmActivity" action="<?php echo($_SERVER["REQUEST_URI"]); ?>" method="post">
    <div class="content_section">
        <div class="content_section">
            ...
            <div style="background-color:#ffffff; " class="content_search_container">
                ...
                &nbsp;
                <div class="left"><input type="text" name="txtSearch" value="<?php echo(htmlentities($var_search)); ?>" class="comm_input input_width1a" onKeyPress="if(window.event.keyCode == '13'){ return false; }" style="width:140px; height:21px!important; margin-right:5px;"></div>
                <div class="left"><a href="javascript:clickSearch();"><img src="./../languages/<?php echo $_SESSION['sess_language'];?>/images/go.gif" style="margin-left:10px; " border="0"></a></div>
                <div class="clear"></div>
            </div>
