        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" class="whitebasic">
            <tr><td width="100%">
                    <div style="background-color:#ffffff; " class="content_search_container">
                        ...
                        &nbsp;
                        <div class="left">
                            <input type="text" name="txtSearch" value="<?php echo(htmlentities($var_search)); ?>" class="comm_input11 input_width3" onKeyPress="if(window.event.keyCode == '13'){ return false; }" style="width:140px">
                            &nbsp;&nbsp;</div>
                        <div class="left">
