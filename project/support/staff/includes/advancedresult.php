...
*/
$sql = "Select t.nTicketId,t.nUserId,t.nDeptId,d.vDeptDesc,t.vRefNo,t.vUserName,t.vTitle,t.tQuestion,t.vPriority,t.merged_from,t.merged_to,
            ...
            <tr align="left"  class="whitebasic">
                ...
                while($cnt < count($fld_arr)) {
                    if($var_orderby == $fld_arr[$cnt][0])
                        ...
                        $img_path = "";
                    ?>
                <th style="text-decoration:none;"><?php echo "<b><a href='?val=".$fld_arr[$cnt][0]."&sorttype=".$var_sorttype."&tp=".$var_type."&cmbDepartment=".$var_deptid."&frm=$var_from&to=$var_to&numBegin=$var_numBegin&start=$var_start&begin=$var_begin&num=$var_num&mt=y&stylename=$var_stylename&styleminus=$var_styleminus&styleplus=$var_styleplus' >".constant($fld_arr[$cnt][1])."</a></b>&nbsp;&nbsp;".$img_path; ?></th>
                    <?php
                    $cnt++;
                }
                //$cnt++;
