...
<form name="frmTicketStatistics" action="<?php echo($_SERVER["REQUEST_URI"]); ?>" method="post">
            ...
            <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td align="right"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="whitebasic">
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        ...
                                        <tr>
                                            ...
                                            <td width="17%"  align="left">
                                                <select name="cmbMonth" class="comm_input input_width3" onChange="javascript:changeMonth();" style="width:80px">
                                                    ...
                                                    <?php for($i=1;$i<=12;$i++) {
                                                        if($i<10)
                                                            ...
                                                            $j=$i;
                                                        ?>
                                                    <option value="<?php echo $j ?>" <?php if($var_month==$j) echo "selected";?>><?php echo date("M",mktime(0,0,0,$i,1,0)) ?></option>
                                                        <?php } ?>
                                                </select>

                                            </td>
                                            <td width="33%"  align="left">
                                                <select name="cmbYear" class="comm_input input_width3" onChange="javascript:changeYear();" style="width:80px">
                                                    <option value="0"><?php echo TEXT_ALL ?></option>
                            ...
                            <tr><td class="whitebasic">&nbsp;</td></tr>
                            <tr>
                                <td class="whitebasic" align=center>
                                    <fieldset style="width:720px;">
                                        <legend class="listingmaintext">
                                            <b>
                                                <?php
                                                ...
                                                echo TICKET_STATISTICS."&nbsp;".$for_or_till."&nbsp;";
                                                echo "&nbsp;&nbsp;";
echo $datedisp ;
?>
