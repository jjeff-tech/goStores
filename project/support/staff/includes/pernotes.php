            ...
            <tr>
                <td width="100%">
                    ...
                    <div style="background-color:#ffffff; " class="content_search_container">
                        ...
                        &nbsp;<div class="left">
                            <input type="text" name="txtSearch" value="<?php echo(htmlentities($var_search)); ?>" class="comm_input input_width3" onKeyPress="if(window.event.keyCode == '13'){ return false; }" style="width:140px; height:21px!important; margin-right:5px;"></div>
