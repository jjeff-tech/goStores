...
<form name="frminteligentsearch" id="frminteligentsearch" action="<?php echo SITE_URL ?>staff/inteligentsearchresult.php" method="post">
    ...
    <div class="intelligentsearch"><input type="text" name="txtinteligentsearch" id="txtinteligentsearch" class="topsearch_input" value="<?php echo $_POST['txtinteligentsearch']; ?>">
