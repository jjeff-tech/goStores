						    ...
						    <td colspan=3 align="center"  id="td2">
							  ...
							  <table width="100%">
									 ...
									 <tr>
										...
										<td width="2%">&nbsp;</td>
										<td width="75%" align="left"><input name="txtPnTitle" type="text" size="70" maxlength="100" class="comm_input input_width1" value="<?php echo htmlentities($var_pntitle);?>" style="width:400px"></td>
									  </tr>
									  <tr>
									   <td colspan="3">&nbsp;</td>
									  </tr>
					   ...
					   <tr>
							...
							<div class="content_section_subtitle"><h3><?php echo TEXT_OTHER_INFO?></h3></div>
							  ...
							  <table align="center" width="100%">
							   <tr>
							    <td align="left" class="listingmaintext" width="18%"><?php echo TEXT_CC?>&nbsp;</td>
							    <td width="1%">&nbsp;</td>
                            ...
                            <tr>
                              <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                  <tr align="center"  class="whitebasic">
                                    <td width="22%">&nbsp;</td>
                                    <td width="16%">
										<input name="btAdd" type="button" class="comm_btn" value="<?php echo BUTTON_TEXT_REPLY ?>" onClick="javascript:save();">
