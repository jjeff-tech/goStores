...
if($_POST["del"] == "UP") {
	...
	if($updatedtickets >0){
    	$message = "<font color=\"red\">" . $updatedtickets . MESSAGE_UPDATE_SUCCESS."</font><br>";
    }
    if($notupdate>0){
	    $message .= "<font color=\"red\">" . $notupdate . MESSAGE_CANNOT_UPDATE."</font>";
    }
}
...
if($_POST["labelup"] == "LABELUP") { 
    ...
    if($notupdate>0){
	    $message .= "<font color=\"red\">" . $notupdate . MESSAGE_RECORD_CANNOT_MOVED."</font>";
    }
}
//end label update
                  ...
                  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td class="pagecolor"><table width="100%"  border="0" cellspacing="0" cellpadding="5">
                          <tr>
                            <td width="93%" class="heading" align="left"><?php echo HEADING_ADVANCED_RESULT ?></td>
                          </tr>
                        </table>
                          <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="listingmaintext">
							<tr>
                                          ...
                                          <td class="whitebasic" >                         
											...
											<?php
												if($_POST["del"] == "DM" or $_POST["del"] == "UP" or $_POST["labelup"] == "LABELUP" or $message !="") {
													echo("<tr><td align=\"center\"  class=\"errormessage\" colspan=11>" . $message . "</td></tr>");
												}
											?>
                                            <tr align="left"  class="whitebasic">
                                              <td width="3%" align="center"><input name="checkall" id="checkall" type=checkbox class=checkbox onClick="checkallfn(<?php echo $var_maxposts;?>)">
                                              </td>
                                              ...
                                              <?php
												...
												$cnt += 2;
											   ?>
                                              <td width="15%" class="listing" style="text-decoration:none;"><?php echo "<b>".TEXT_DUE."</b>";?></td>
                                            </tr>
                                            <?php
                                            ...
                                            <tr align="left"  class="whitebasic">
                                              <td colspan="<?php echo $cnt+1; ?>" width="100%">
											   <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                  <tr class="whitebasic">
                                                    <td width="36%" colspan="2"><table width="50%" border="0" align=center class="column1" cellpadding="0" cellspacing="1">
                                                        <tr class="listing">
														  <td width="14%" class="listing"><?php echo "<b>".TEXT_ACTION_TICKETS."</b>"; ?></td>
                                                          <td width="23%" align=left class="listing"><?php echo "<b>".TEXT_CHANGESTATUS_TICKETS."</b>"; ?></td>
                                                          <td width="16%" align="left" class="listing"><?php echo "<b>".TEXT_CHANGELABEL_TICKETS."</b>"; ?></td>
														  <td width="47%" rowspan="2" align="center"><a href="javascript:clickUpdate(0);"  class="listing" style="text-decoration:none;"><img src='./../languages/<?php echo $_SESSION['sess_language'];?>/images/go.gif' border=0></a></td>
                                                        </tr>
                                                        <tr>
														  <td>
