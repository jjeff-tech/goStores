...
//				$var_refno=$var_compid."-".$deptid."-".$var_userid."-".$var_insert_id;
				...
				if($vAttachmentfiles !=""){
				   ...
				   if(logActivity()) {
					   $sql = "Insert into sptbl_actionlog(nALId,nStaffId,vAction,vArea,nRespId,dDate) Values('','$var_staffid','" . TEXT_ADDITION . "','Ticket','" . mysql_real_escape_string($var_ticketid) . "',now())";			
