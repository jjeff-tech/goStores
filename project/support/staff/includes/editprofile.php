...
// +----------------------------------------------------------------------+
        ...
        if ($_POST["postback"] == "" && $var_id != "") {
                ...
                $sql .= "nNotifyPvtMsg,nNotifyKB,nNotifyArrival,vType,tSignature, vStaffImg from sptbl_staffs where nStaffId = '" . mysql_real_escape_string($var_id) . "' AND vDelStatus='0' ";
        ...
        elseif ($_POST["postback"] == "U") {
						...
						$sql1 ="select vStaffImg from sptbl_staffs where nStaffId='".mysql_real_escape_string($var_id)."'";
...
?>
<form name="frmStaff" method="POST" action="<?php echo($_SERVER["REQUEST_URI"]); ?>" enctype="multipart/form-data">
