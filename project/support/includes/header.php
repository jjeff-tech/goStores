<?php
include("./includes/sever_injection.php");
    ...
    <div class="header_cnt sitewidth">
        <div class="header_left">
            <div class="mainlogo">
                ...
                ?>
                <a href="mainpage.php"><img src="<?php echo(SITE_URL.$img_logo); ?>" border="0" ></a>
            </div>
        ...
        <div class="header_right">
            ...
            <div class="menu_right" style="float: left;">
                ...
                <a <?php if($PostTicketBeforeLogin == 1) { ?> href="#" onclick="javascript:jAlert('<?php echo MESSAGE_ERROR_LOGIN; ?>','<?php echo HEADING_LOGIN; ?>');" <?php }else { ?> href="<?php echo SITE_URL; ?>postticketbeforeregister.php" <?php } ?>><?php echo CREATE_TICKET ?></a>
                </div>
            ...
            <div class="livechat_box right" style="padding-top:4px;z-index: 1000;">
...
<div class="menu_row">
    <div class="menu_cnt sitewidth">
        ...
        <div class="menu_right">
            <ul class="topmenu">
                <li><a href="<?php echo BASE_URL;?>" >Main Site</a></li>
                <li><a href="mainpage.php" <?php if($page == 'userhome' || $page == '') { ?> class="selected" <?php } ?> ><?php echo HEADING_HOME;?></a></li>
                <?php
