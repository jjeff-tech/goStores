...
$var_posttopostgap="2";
$var_post_flag=true;
$var_username=$_SESSION["sess_temp_username"];
...
//				$var_refno=$var_compid."-".$deptid."-".$var_userid."-".$var_insert_id;
            ...
            if(logActivity()) {
                $sql = "Insert into sptbl_actionlog(nALId,nUserId,vAction,vArea,nRespId,dDate) Values('','$var_userid','" . TEXT_ADDITION . "','Ticket','" . mysql_real_escape_string($var_insert_id) . "',now())";
...
//				 $var_tolist = substr($var_tolist,1);
            ...
            $var_message = MESSAGE_TEXT.' '.$var_refno;
            //$var_message1= TEXT_TICKET_REFERENCE_NUMBER.": ".$var_refno.'<br/>'.TEXT_ACCOUNT_DETAILS ;
            $var_message1= '<br/>'.TEXT_ACCOUNT_DETAILS ;
        }
