...
$sql = "Select t.nTicketId,t.nDeptId,t.vUserName,t.vTitle,t.vRefNo,t.dPostDate,t.tQuestion,t.vPriority,t.vStatus,t.nOwner,
		...
		on t.nTicketId=a.nTicketId Where t.nTicketId='" . mysql_real_escape_string($var_tid) ."' AND t.nUserId='" . mysql_real_escape_string($var_userid) . "' ";
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                           ...
                                           <tr align="left"  class="listingmaintext">
												<td colspan="4" width="100%" style="word-break:break-all; ">
													<br><b><?php echo   TEXT_TITLE?> : <?php echo $row["vTitle"]; ?></b><br>&nbsp;
												</td>
									  </tr>	
                                            <tr>
                                               ...
                                               <table width="100%"  border="0" cellpadding="0" cellspacing="3"  >
												<tr align="left"  class="toplinks">
													<td colspan="4" width="10%" style="word-break:break-all;">
														<?php echo nl2br(htmlentities($row["tQuestion"])); ?>
													</td>
										      </tr>								  
                                              <tr align="left" >
										...
										<tr>
												<td colspan="4">
													<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="attachbg">
														<tr align="center">
														  <td colspan="4"><?php 
															  echo("<a href=\"javascript:var lg=window.open('./attachments/" . $row["vAttachUrl"] . "');\">". $row["vAttachReference"] . "</a>");
...
$sql = "Select r.nReplyId,r.nStaffId,r.vStaffLogin,r.nUserId,r.dDate,r.vMachineIP,tReply,
		...
		r.nReplyId = a.nReplyId Where r.nTicketId='" . mysql_real_escape_string($var_tid) ."'  ORDER BY r.dDate ";
$rs = executeSelect($sql,$conn);
...
?>
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
												...
												<td colspan="4">
													<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="blackbg">
														...
														?>
														  ...
														  <td width="14%" align="center"><a href="replies.php?rp=r&tk=<?php echo($var_ticketid); ?>&rid=<?php echo($row["nReplyId"]); ?>&&stylename=<?php echo($var_stylename); ?>&styleminus=<?php echo($var_styleminus); ?>&styleplus=<?php echo($var_styleplus); ?>&"><?php echo TEXT_REPLY?></a></td>
														  <td width="18%" align="center"><a href="replies.php?rp=q&tk=<?php echo($var_ticketid); ?>&rid=<?php echo($row["nReplyId"]); ?>&&stylename=<?php echo($var_stylename); ?>&styleminus=<?php echo($var_styleminus); ?>&styleplus=<?php echo($var_styleplus); ?>&"><?php echo TEXT_QUOTE_AND_REPLY?></a> </td>
														  <td width="11%" align="center"><?php echo   TEXT_COMMENT?></td>
														 <?php 
														 }
														 else{
														 ?>
											...
											?>
											<tr><td colspan=4 bgcolor=red ><?php echo   TEXT_COMMENTS?></td></tr>
											<tr><td colspan=4><?php echo stripslashes($row["tPvtMessage"]); ?></td></tr>
											 <?php
