...
$sql .=" where u.nCompId=c.nCompId and u.nUserId='".mysql_real_escape_string($_SESSION["sess_userid"])."'";
...
<div class="content_section">
    <form action="" method="post" name="frmProfile">
        ...
        <div class="content_section_data">
            ...
            <table width="100%"  border="0" cellpadding="0" cellspacing="0" border="0" class="comm_tbl">
                <tr>
            ...
            <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="comm_tbl">
                <tr>
                    ...
                    <td align="left" width="79%">
                        <input name="btnSubmit" type="button" class="comm_btn" value="<?php echo BUTTON_TEXT_UPDATE?>" onClick="javascript:validateProfileForm();">
