  ...
  <tr>
	...
	/*			$display_text=TEXT_CHECK_LOOKUP;
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" class="topbar">
		<tr>
		  <td width="97%" align="right" class="toplinks">Powered by <a href="http://www.iscripts.com/autohoster" style="text-decoration:none;color:#FFFF00">iScripts Autohoster</a></td>
