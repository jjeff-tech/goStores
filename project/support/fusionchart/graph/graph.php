...
class graph extends fusioncharts
{
	...
	public function __construct($graphType, $width =450, $height=250)
        {
            ...
            if($graphType==1)
            {
               ...
               $this->FD = new fusioncharts("MSColumn3D", $width, $height, "","transparent");

               # Set the relative path of the swf file
               //$this->FD->setSWFPath(BASE_URL."public/FusionCharts/FusionCharts/");
               $this->FD->setSWFPath("../fusioncharts/FusionCharts/");
               ...
               $this->FD->setChartParams($strParam);
                ...
                $this->FD->setSwfPath("FusionCharts/");
            }else if($graphType==8){
                 # Create FusionCharts PHP Class object for single series column3d chart
                 $this->FD = new FusionCharts("Column3D", $width, $height);

                   # Set Relative Path of chart SWF file.
                 $this->FD->setSwfPath("../fusionchart/FusionCharts/");
            }
            else if($graphType==3){
                 # Create FusionCharts PHP Class object for single series column3d chart
                 $this->FD = new FusionCharts("Bar2D", $width, $height);
  ...
  $this->FD = new FusionCharts("Pie3D", $width, $height);
             ...
             //  $this->FD->setChartParams($strParam);
                 ...
                 # Create FusionCharts PHP Class object for single series column3d chart
                 $this->FD = new FusionCharts("MSLine", $width, $height);
 $strParam="caption=;formatNumberScale=1;rotateValues=1;decimalPrecision=0";
               ...
               $this->FD->setChartParams($strParam);
                 ...
                 # Create FusionCharts PHP Class object for single series column3d chart
                 $this->FD = new FusionCharts("StackedColumn3D", $width, $height);
 $strParam="caption=;formatNumberScale=5;rotateValues=1;decimalPrecision=0";
        ...
        public function setChartParams($caption = 'caption', $formatNumberScale = 1, $rotateValues = 1, $decimalPrecision = 1, $numvDivLines = 5 ,$showLabels= 1){
             # Define chart attributes
             $strParam="caption=$caption;formatNumberScale=$formatNumberScale;rotateValues=$rotateValues;decimalPrecision=$decimalPrecision;numDivLines=$numvDivLines;showLabels=$showLabels;yAxisMinValue=0;yAxisMaxValue=10;";
              # Set chart attributes
              $this->FD->setChartParams($strParam);
        }
