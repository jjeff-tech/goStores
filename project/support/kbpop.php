...
<table width="100%" class="column1"  border="0" cellspacing="1" cellpadding="5">
    ...
    <tr class="listing"><td width="100%" class="heading" height="10"><?php echo TEXT_KNOWLEDGEBASE_DETAILS; ?></td></tr>
    <tr class="listing"><td>

    <tr align="left"  class="fieldnames">
        <td colspan="5" style="word-break:break-all; "><?php echo TEXT_TITLE; ?> :

            <br><br><b><?php echo $var_name; ?></b><br>&nbsp;
        </td>
    </tr>
    <tr>
    <tr align="left"  class="fieldnames">
        <td colspan="5" style="word-break:break-all; "><?php echo TEXT_KNOWLEDGEBASE_DESC; ?> : 
            <br><br><b><?php echo $var_desc; ?></b><br>&nbsp;
        </td>
    </tr>
    <tr>
