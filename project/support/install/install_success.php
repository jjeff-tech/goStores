                                ...
                                <fieldset>
                                    ...
                                    <table cellpadding="0" cellspacing="0" width="95%" class="maintext" align="center">
                                        ...
                                        <tr>
                                         ...
                                         <tr>
                                            <td width="26%"><b><font size="-1">Staff URL&nbsp;:</font></b></td>
                                            <td width="74%"><a style="cursor:pointer;text-decoration: none;" href="<?php echo BASE_URL . "staff" ?>"><img src="css/admin_login_install.jpg" border="0" height="25" align="absmiddle">&nbsp; &nbsp; <?php echo BASE_URL . "staff"; ?></a></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td  valign="top"><b><font size="-1">Staff Credentials&nbsp;:</font></b></td>
                                            <td  valign="top">
                                                <div class="adm_cred">
                                                    <font size="-1">Username&nbsp;:&nbsp;staff</font><br/><br/>
                                                    <font size="-1">Password&nbsp;:&nbsp;staff</font>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
