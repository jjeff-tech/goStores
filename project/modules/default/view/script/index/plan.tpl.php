...
<div class="plan_main_outer">

<div class="container">
	<div class="main-titile marg20_top">
		<h2>PLANS</h2>
		<h3>A plan to suit every stage of your business.</h3>
     ...
     <div class="plan_cont_main_outer">
		<div class="plan_cont_outer">
			...
			<div class="content">
				...
				<div class="btt_outer">
                                    <a href="<?php echo ConfigUrl::base(); ?>index/paynowredirect?plan_id=<?php echo base64_encode(base64_encode($v['plan_id']))?>">Select</a>
				<div class="clearfix"></div>
				</div>
			</div>
		<div class="clearfix"></div>
