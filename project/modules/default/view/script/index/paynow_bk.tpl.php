...
$paymentCount++;
?>
<div class="full-width"><img src="<?php echo BASE_URL; ?>project/styles/images/bluedog-logo.png"  title="BlueDog" onclick="showPaymentdiv('bluedog')" style="margin-top: 15px;"></div>
<?php
}
if($paymentCount % 5 ==0)
echo '</tr><tr>';
...
<td  align="left"><input name="RegistrantFirstName" id="RegistrantFirstName" autocomplete="off" type="text" class="comm_input" value="<?php echo $_POST["RegistrantFirstName"] ? $_POST["RegistrantFirstName"] : $this->userDetails->vFirstName; ?>" style="width:230px; "> </td>
</tr>
<tr>
<td  align="left"  valign="center"> Last Name<span class="mandred">*</span></td>
<td align="left"><input name="RegistrantLastName" id="RegistrantLastName" autocomplete="off" type="text" class="comm_input" value="<?php echo $_POST["RegistrantLastName"] ? $_POST["RegistrantLastName"] : $this->userDetails->vLastName; ?>" style="width:230px; "></td>
</tr>
<tr>
<td align="left"  valign="center">Email&nbsp;Address<span class="mandred">*</span></td>
<td align="left"><input name="RegistrantEmailAddress" id="RegistrantEmailAddress" autocomplete="off" type="text" class="comm_input" value="<?php echo $_POST["RegistrantEmailAddress"] ? $_POST["RegistrantEmailAddress"] : $this->userDetails->vEmail; ?>" style="width:230px; "><span id="jqShowEmailAccountMessage" class="domainsearchfaild" style="display:none"> Account exists with email id.Please <a class="jqLoginInnerDiv" href="#">Login</a> to continue</span>
...
<td align="left"><input name="RegistrantAddress1" id="RegistrantAddress1" type="text" class="comm_input" autocomplete="off" value="<?php echo $_POST["RegistrantAddress1"] ? $_POST["RegistrantAddress1"] : $this->userDetails->vAddress; ?>" style="width:230px; "></td>
</tr>
<tr>
...
<td><input type="text" autocomplete="off" id="RegistrantStateOther" name="RegistrantStateOther" value="<?php echo $this->userDetails->vState ? $this->userDetails->vState : $this->state; ?>" maxlength="255"></td>
</tr>
<tr id="dom_us_states">
<td align="left"><?php
...
<td align="left"><input name="RegistrantCity" id="RegistrantCity" type="text" class="comm_input" autocomplete="off" value="<?php echo $_POST["RegistrantCity"] ? $_POST["RegistrantCity"] : $this->userDetails->vCity; ?>" style="width:230px; "></td>
</tr>
<tr>
<td align="left"  valign="center">ZIP/Postal&nbsp;Code<span class="mandred">*</span></td>
<td align="left"><input name="RegistrantPostalCode" id="RegistrantPostalCode" autocomplete="off" value="<?php echo $_POST["RegistrantPostalCode"] ? $_POST["RegistrantPostalCode"] : $this->userDetails->vZipcode; ?>" type="text" class="comm_input" style="width:230px; " maxlength="10"></td>
</tr>                                                    
<tr>
