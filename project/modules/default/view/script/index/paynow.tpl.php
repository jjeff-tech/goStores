...
*/
//echo BASE_URL.'project/lib/stripe/init.php';exit;
...
<div class="content_area_inner paynow-bg">
   <div class="container"> 
<!--       <div class="sub_container" style="background-color: #FCFCFC;min-height: 500px;" >   -->
<div class="col-md-8 col-md-offset-2" style="background-color: #FCFCFC;margin-bottom: 15px;display:none;min-height: 500px;" id="progressDiv">
<div>
...
<div class="tab-panel-hd-right left"></div>
    ...
    <div id="tabs_content_container" style="border:0px none;">
...
<div id="tab1" class="tab_content tab-bg" style="display: block;">
...
<div class="col-md-8">
<input type="text" id="fname" name="fname" autocomplete="off" value="<?php echo $this->userDetails->vFirstName ? $this->userDetails->vFirstName : PageContext::$response->firstName; ?>" class="form-control">
</div>
</div>
<div class="full-width">
	<div class="col-md-4 l-ht">
	...
	<div class="col-md-8">
		<input type="text" id="lname" name="lname" autocomplete="off" value="<?php echo $this->userDetails->vLastName ? $this->userDetails->vLastName : PageContext::$response->lastName; ?>" class="form-control">
	</div>
</div>
<div class="full-width">
		<div class="col-md-4 l-ht">
		...
		<div class="col-md-8">
			<input type="text" id="email" name="email" autocomplete="off" value="<?php echo $this->userDetails->vEmail ? $this->userDetails->vEmail : PageContext::$response->emailAddress; ?>" class="form-control">
...
<div class="full-width">
	...
	<div class="col-md-8">
		<input type="text" id="phone" name="phone" autocomplete="" value="<?php echo $this->userDetails->vPhoneNumber ? $this->userDetails->vPhoneNumber : PageContext::$response->phone; ?>" class="form-control">
	</div>
</div>
...
<div class="full-width">
	...
	<div class="col-md-8">
		<input type="text" id="add1" name="add1" autocomplete="off" value="<?php echo $this->userDetails->vAddress ? $this->userDetails->vAddress : $this->address; ?>" class="form-control">
	</div>
</div>
...
<?php
$selectedCountry = stripslashes($this->userDetails->vCountry ? $this->userDetails->vCountry : $this->country);
if ($selectedCountry == "")
$countryKey = "US";
else
...
?>
<option value="<?php echo $key ?>" <?php if ($key == $countryKey || $value == $this->userDetails->vCountry)
...
<input type="text" autocomplete="off" id="state" name="state" value="<?php echo $this->userDetails->vState ? $this->userDetails->vState : $this->state; ?>" maxlength="255">
</div>
   </div> 
    </div>
<div class="full-width" id="subdom_us_states">
	<div class="col-md-4 l-ht">
		State<span class="mandred">*</span>
	</div>
	<div class="col-md-8" >
...
?>
<option value="<?php echo $key ?>" <?php if ($key == $countryKey || strtolower($value) == strtolower($this->userDetails->vState))
...
<input type="text" id="city" name="city" autocomplete="off" value="<?php echo $this->userDetails->vCity ? $this->userDetails->vCity : $this->city; ?>" class="form-control">
	</div>
</div>
...
<div class="full-width">
	...
	<div class="col-md-8">
<input type="text" id="zip" name="zip" autocomplete="off" value="<?php echo $this->userDetails->vZipcode ? $this->userDetails->vZipcode : $this->zip; ?>" 
class="form-control">
	</div>
</div>
	...
	<div class="full-width pymntnew_tbl">
		<div class="full-width">
			...
			<div class="col-md-3">
               ...
               <div class="col-md-3">
				<input type="button" name="jqCoupon" id="removecode" onclick="removecouponcode('couponNumber2')" value="REMOVE" class="button_orange2 btn-orng">
			</div>
			
                  
         </div>
                 <div class="col-md-12"><div id="couponNumber2_err"></div></div>
...
<td valign="top" align="left" width="310">
 <input type="text" id="couponNumber2" name="couponNumber" maxlength="16" class="width1" class="input_newstyle01">
</td>
<td>
...
<tr><td colspan="3"><div id="couponNumber2_err"><label class="error">&nbsp;</label></div></td></tr>
</table>
...
<div class="col-md-12 payment-opt-sec">
...
$paymentCount++;
?>
<div class="full-width"><img src="<?php echo BASE_URL; ?>project/styles/images/paypal_pro_logo.png"  title="Paypalpro" onclick="showPaymentdiv('paypalpro')"></div>
<?php
}
if($paymentCount % 5 ==0)
echo '</tr><tr>';
...
?>
<div class="full-width"><img src="<?php echo BASE_URL; ?>project/styles/images/paypal_payflow_logo.png"  title="Paypalflow" onclick="showPaymentdiv('paypalflow')"></div>
<?php
}
if($paymentCount % 5 ==0)
echo '</tr><tr>';
...
$paymentCount++;
?>
<div class="full-width"><img src="<?php echo BASE_URL; ?>project/styles/images/authorizenet_logo.png"  title="Authorize" onclick="showPaymentdiv('authorize')"></div>
<?php
}
if($paymentCount % 5 ==0)
echo '</tr><tr>';
...
$paymentCount++;
?>
<div class="full-width"><img src="<?php echo BASE_URL; ?>project/styles/images/bluedog-logo.png"  title="BlueDog" onclick="showPaymentdiv('bluedog')"></div>
<?php
}
...
<div class="loader" style="display:none;"><img src="<?php echo BASE_URL; ?>project/styles/images/ajax-loader.gif"  title="loading"></div>
...
<input type="hidden" name="stripe_sessionid" value="<?php echo PageContext::$response->stripetoken;?>" id="stripe_sessionid">
<input type="hidden" name="stripe_publishkey" value="<?php echo PageContext::$response->stripesettings['PublishKey'];?>" id="stripe_publishkey">

<?php 
//echopre(PageContext::$response->stripesettings);
if(isset (PageContext::$response->paymnetsEnabled['stripe_enable']) && PageContext::$response->paymnetsEnabled['stripe_enable'] == 'Y'){
$paymentCount++;
?>
<div class="full-width">
<script src="https://js.stripe.com/v3"></script>
<button id="checkout-button" class="btn-xl" onclick="setStripe()"></button>
</div>

<div class="full-width-payment">
...
<div class="full-width" id="jqRegisterYears">
<div class="col-md-4 l-ht">
Period&nbsp;to&nbsp;Register<span class="mandred">*</span>
</div>
<div class="col-md-8">
<select class="form-control" name="NumYears" id="jqNumYears">
...
<div class="full-width">
<div class="col-md-4 l-ht">First Name<span class="mandred">*</span><label for="fname" id="err_fname" class="error" style="display:none;">Please enter first name</label></div>
<div class="col-md-8"><input name="RegistrantFirstName" id="RegistrantFirstName" autocomplete="off" type="text" class="form-control" value="<?php echo $_POST["RegistrantFirstName"] ? $_POST["RegistrantFirstName"] : $this->userDetails->vFirstName; ?>"> </div>
</div>


<div class="full-width">
<div class="col-md-4 l-ht"> Last Name<span class="mandred">*</span><label for="lname" id="err_lname" class="error" style="display:none;">Please enter last name</label></div>
<div class="col-md-8"><input name="RegistrantLastName" id="RegistrantLastName" autocomplete="off" type="text" class="form-control" value="<?php echo $_POST["RegistrantLastName"] ? $_POST["RegistrantLastName"] : $this->userDetails->vLastName; ?>"></div>
</div>



<div class="full-width">
<div class="col-md-4 l-ht">Email&nbsp;Address<span class="mandred">*</span></div>
<div class="col-md-8">
	<input name="RegistrantEmailAddress" id="RegistrantEmailAddress" autocomplete="off" type="text" class="form-control" value="<?php echo $_POST["RegistrantEmailAddress"] ? $_POST["RegistrantEmailAddress"] : $this->userDetails->vEmail; ?>" >
	<span id="jqShowEmailAccountMessage" class="domainsearchfaild" style="display:none"> Account exists with email id.Please <a class="jqLoginInnerDiv" href="#">Login</a> to continue</span>
<input type="hidden" id="jqRegistrantAccountExistence" value="0"></div>
</div>



<div class="full-width">
<div class="col-md-4 l-ht">Job<span class="mandred">*</span></div>
<div class="col-md-8"><input name="RegistrantJobTitle" id="RegistrantJobTitle" autocomplete="off" value="<?php echo $_POST["RegistrantJobTitle"]; ?>" type="text" class="form-control"></div>
</div>



<div class="full-width">
<div class="col-md-4 l-ht">Organization&nbsp;Name<span class="mandred">*</span></div>
<div class="col-md-8"><input name="RegistrantOrganizationName" id="RegistrantOrganizationName" autocomplete="off" value="<?php echo $_POST["RegistrantOrganizationName"]; ?>" type="text" class="form-control" ></div>
</div>



<div class="full-width">
<div class="col-md-4 l-ht">Address1<span class="mandred">*</span></div>
<div class="col-md-8"><input name="RegistrantAddress1" id="RegistrantAddress1" type="text" class="form-control" autocomplete="off" value="<?php echo $_POST["RegistrantAddress1"] ? $_POST["RegistrantAddress1"] : $this->userDetails->vAddress; ?>"></div>
</div>



<div class="full-width">
<div class="col-md-4 l-ht">Address2</div>
<div class="col-md-8"><input name="RegistrantAddress2" id="RegistrantAddress2" type="text" class="form-control" autocomplete="off" value="<?php echo $_POST["RegistrantAddress2"]; ?>"></div>
</div>


<div class="full-width">
<div class="col-md-4 l-ht">Country<span class="mandred">*</span></div>
<div class="col-md-8">
<select name="RegistrantCountry" id="idRegistrantCountry" class="form-control"  onchange="checkdomstatevalue(this.value);">
<?php
global $countries;
foreach ($countries as $key => $value) {
?>
...
<div class="full-width" id="dom_non_us_states" style="display:none;">

<div class="col-md-4 l-ht">State<span class="mandred">*</span></div>
<div class="col-md-8"><input type="text" autocomplete="off" id="RegistrantStateOther" name="RegistrantStateOther" value="<?php echo $this->userDetails->vState ? $this->userDetails->vState : $this->state; ?>"></div>

</div>

<div class="full-width" id="dom_us_states">

<div class="col-md-4 l-ht"><?php
$strStateValue = trim($_POST["RegistrantState"] ? $_POST["RegistrantState"] : $this->userDetails->vState );
?>
US State&nbsp;&nbsp;
...
?>
 onclick="fnRegistrantStateSelected()">&nbsp;&nbsp;&nbsp;</div>
<div class="col-md-8"> <select name="RegistrantState" id="RegistrantState" size="1" class="form-control" >
<?php
global $usStates;
...
<div class="full-width" id="dom_us_province">

<div class="col-md-4 l-ht">Province
<input type="radio" size="14" value="P" name="RegistrantStateProvinceChoice" id="radio2" <?php
if ($strProvinceValue != "") {
echo "checked";
}
?>  onclick="fnRegistrantProvinceSelected()" >&nbsp;&nbsp;&nbsp;</div>

<div class="col-md-8"><input  type="text" class="form-control" name="RegistrantProvince" id="RegistrantProvince" 
value="<?php echo $strProvinceValue; ?>"></div>

</div>

<div class="full-width" id="dom_us_na">
<div class="col-md-4 l-ht">Not&nbsp;Applicable
<input type="radio" value="Blank" name="RegistrantStateProvinceChoice" id="radio3" <?php
if ($strStateValue == '' && $strProvinceValue == '') {
echo "checked";
}
?>  onclick="fnRegistrantNoneSelected()">&nbsp;&nbsp;&nbsp;</div>
<div class="col-md-8">&nbsp;&nbsp;&nbsp;(the state/province field will be left blank) <b class="red"></b></div>
...
<div class="col-md-4 l-ht">City<span class="mandred">*</span></div>
<div class="col-md-8"><input name="RegistrantCity" id="RegistrantCity" type="text" class="form-control" autocomplete="off" value="<?php echo $_POST["RegistrantCity"] ? $_POST["RegistrantCity"] : $this->userDetails->vCity; ?>" ></div>

</div>

<div class="full-width" >
<div class="col-md-4 l-ht">ZIP/Postal&nbsp;Code<span class="mandred">*</span></div>
<div class="col-md-8"><input name="RegistrantPostalCode" id="RegistrantPostalCode" autocomplete="off" value="<?php echo $_POST["RegistrantPostalCode"] ? $_POST["RegistrantPostalCode"] : $this->userDetails->vZipcode; ?>" type="text" class="form-control"></div>
</div>

<div class="full-width">
<div class="col-md-4 l-ht">Fax</div>
<div class="col-md-8"><input name="RegistrantFax" id="RegistrantFax" autocomplete="off" type="text" class="form-control" value="<?php echo $_POST["RegistrantFax"]; ?>"  onkeypress="validate(event);"></div>
</div>


<div class="full-width">
<div class="col-md-4 l-ht">Phone<span class="mandred">*</span></div>
<div class="col-md-8"><input name="RegistrantPhone" autocomplete="off" id="RegistrantPhone" type="text" class="form-control" value="<?php echo $_POST["RegistrantPhone"]; ?>"  onkeypress="validate(event);"></div>
</div>
...
$paymentCount++;
?>
<td><img src="<?php echo BASE_URL; ?>project/styles/images/bluedog-logo.png"  title="BlueDog" height="" width="" onclick="showPaymentdiv('bluedogdomain')"></td>
<?php
}
...
<input type="hidden" name="stripe_sessionid" value="<?php echo PageContext::$response->stripetoken;?>" id="stripe_sessionid">
<input type="hidden" name="stripe_publishkey" value="<?php echo PageContext::$response->stripesettings['PublishKey'];?>" id="stripe_publishkey">
<td><button id="checkout-button" class="btn-xl" onclick="setStripe()"></button></td>
<?php
}
if($paymentCount % 5 ==0)
echo '</tr><tr>';
