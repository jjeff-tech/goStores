                                        ...
                                        <div>
                                            ...
                                            <div class="information">
                                                <div class="display_table">
                                                    <div class="display_table-cell vert_align_middle pad5px_right"><span>http://</span></div>
                                                    <div class="display_table-cell vert_align_middle pad5px_right"><input type="text" size="50" class="form-control" name="txtStoreName" id="txtStoreName"></div>
                                                    <div class="display_table-cell vert_align_middle pad10px_right"><span>.<?php echo DOMAIN_NAME ?></span></div>
                                                </div>
                                            </div>
                                             <div class="information">
                                                <div class="display_table">
                                                    <div class="display_table-cell vert_align_middle"><input type="button" value="Check Availability" id="jqCheckSubdomainExist"></div>
                                                </div>
                                            </div>
                                            <div class="clear"></div>
                                        </div>
                            ...
                            <div class="tab-review-row">
                                <div class="tab-review-right">
                                    ...
                                    <div class="proceed_content_box3" style="display:none;">
                                        <form id="frmUsers" name="frmUsers" class="form-horizontal" method="POST">
                                            <div class="col-xs-12 col-sm-12 col-md-6">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-sm-8">
                                                    <input class="form-control" id="fname" name="fname" value="<?php echo $this->cardDetails->vFirstName ? $this->cardDetails->vFirstName : $this->fname; ?>" maxlength="255">
                                                  </div>
                                              </div>
                                              <div class="form-group">
                                                  <label for="inputName" class="col-sm-3 control-label">Last Name <span class="text-danger small">*</span></label>
                                                  <div class="col-sm-8">
                                                    <input class="form-control" id="lname" name="lname" value="<?php echo $this->cardDetails->vLastName ? $this->cardDetails->vLastName : $this->lname; ?>" maxlength="255">
                                                  </div>
                                              </div>
                                              <div class="form-group">
                                                  <label for="inputName" class="col-sm-3 control-label">Email <span class="text-danger small">*</span></label>
                                                  <div class="col-sm-8">
                                                    <input class="form-control" id="email" name="email" value="<?php echo $this->cardDetails->vEmail ? $this->cardDetails->vEmail : $this->email; ?>" maxlength="255">
                                              ...
                                              <div class="form-group">
                                                  <label for="inputName" class="col-sm-3 control-label">Address <span class="text-danger small">*</span></label>
                                                  <div class="col-sm-8">
                                                    <input class="form-control" id="add1" name="add1" value="<?php echo $this->cardDetails->vAddress ? $this->cardDetails->vAddress : $this->address; ?>" maxlength="255">
                                                  </div>
                                              </div>
                                              <div class="form-group">
                                                  <label for="inputName" class="col-sm-3 control-label">City <span class="text-danger small">*</span></label>
                                                  <div class="col-sm-8">
                                                    <input class="form-control" id="city" name="city" value="<?php echo $this->cardDetails->vCity ? $this->cardDetails->vCity : $this->city; ?>" maxlength="255">
                                                  </div>
                                              </div>
                                              <div class="form-group">
                                                  <label for="inputName" class="col-sm-3 control-label">State <span class="text-danger small">*</span></label>
                                                  <div class="col-sm-8">
                                                    <input class="form-control" id="state" name="state" value="<?php echo $this->cardDetails->vState ? $this->cardDetails->vState : $this->state; ?>" maxlength="255">
                                                  </div>
                                              </div>
                                              <div class="form-group">
                                                  <label for="inputName" class="col-sm-3 control-label">ZIP/Postal&nbsp;Code <span class="text-danger small">*</span></label>
                                                  <div class="col-sm-8">
                                                    <input class="form-control" id="zip" name="zip" value="<?php echo $this->cardDetails->vZipcode ? $this->cardDetails->vZipcode : $this->zip; ?>" maxlength="8">
                                                  </div>
                                              </div>
                                              <div class="form-group">
                                                  <label for="inputName" class="col-sm-3 control-label">Country <span class="text-danger small">*</span></label>
                                                  <div class="col-sm-8">
									...
									<td valign="middle" align="left" >
                                              ...
                                              <!--  <div class="payment_right_container">
                                                ...
                                                <div class="payment_right_container">
                                                    ...
                                                    <div class="display_table wid100p greycell">
                                                        ...
                                                        <div class="display_table_row">
                                                         ...
                                                         //  echopre(PageContext::$response->paymnetsEnabled);
                                                            ...
                                                            if(isset (PageContext::$response->paymnetsEnabled['paypal_enable']) && PageContext::$response->paymnetsEnabled['paypal_enable'] == 'Y'){
                                                                $paymentCount++;
                                                                ?>
                                                            <div class="display_table-cell vert_align_middle">
                                                            ...
                                                            <?php
                                                             ...
                                                             if($paymentCount % 5 ==0)
                                                                echo '</div><div class="display_table_row">';

                                                            if(isset (PageContext::$response->paymnetsEnabled['paypalpro_enable']) && PageContext::$response->paymnetsEnabled['paypalpro_enable'] == 'Y'){
                                                                $paymentCount++;
                                                                ?>
                                                            <div class="display_table-cell vert_align_middle"><img src="<?php echo BASE_URL; ?>project/styles/images/paypal_pro_logo.png"  title="Paypalpro" onclick="showPaymentdiv('paypalpro')"></div>
                                                            <?php
                                                            }
                                                             if($paymentCount % 5 ==0)
                                                                echo '</div><div class="display_table_row">';
                                                            ...
                                                            ?>
                                                            <div class="display_table-cell vert_align_middle"><img src="<?php echo BASE_URL; ?>project/styles/images/paypal_payflow_logo.png"  title="Paypalflow" onclick="showPaymentdiv('paypalflow')"></div>
                                                            <?php
                                                            }
                                                             if($paymentCount % 5 ==0)
                                                                echo '</div><div class="display_table_row">';
                                                           ...
                                                           <?php
                                                            if(isset (PageContext::$response->paymnetsEnabled['authorize_enable']) && PageContext::$response->paymnetsEnabled['authorize_enable'] == 'Y'){
                                                                $paymentCount++;
                                                                ?>
                                                           <div class="display_table-cell vert_align_middle"><img src="<?php echo BASE_URL; ?>project/styles/images/authorizenet_logo.png"  title="Authorize" onclick="showPaymentdiv('authorize')"></div>
                                                            <?php
                                                            }
                                                            if($paymentCount % 5 ==0)
                                                                echo '</div><div class="display_table_row">';
                                                    ...
                                                    <div class="display_table wid100p greycell">
                                                        <div class="display_table_row">
                                                            <div class="display_table-cell cls_payment">
                                            ...
                                            <div class="payment_form">
                                                ...
                                                <table width="100%"  border="0" cellspacing="0" cellpadding="2" align="center">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left"><input name="RegistrantPostalCode" id="RegistrantPostalCode" value="<?php echo $_POST["RegistrantPostalCode"] ? $_POST["RegistrantPostalCode"] : $this->cardDetails->vZipcode; ?>" type="text" class="comm_input" style="width:230px; " maxlength="8"></td>
                                                    </tr>
                                                    <tr>
