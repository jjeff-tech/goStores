...
// 	var planName = $("#product_name").val();
// 	var secretKey= $("#stripe_SecretKey").val();
// 	var email = $("#Semail").val();
//     var PublishKey = $("#stripe_publishkey").val();

//             //alert(PublishKey);return false;
//     var stripe = Stripe(PublishKey);

// 	//alert(email);return false;

// 	//alert(SetUpgradeStripeToken);return false;
// 	var ajaxSubmitOption 	= {
//             url      : SetUpgradeStripeToken,
//             data     : "price="+price+"&plan="+planName+"&key="+secretKey+"&email="+email,
//             type     : "post",
//             dataType : "json",
...
<div class="full-width-new payment_option1_colleft">
<div id="tabs_content_container">
    
    
    <!-- Display area for " PROCEED TO PAY "-->
<div class="col-md-8 col-md-offset-2" style="display:none;"  id="jqProgress">
...
<div id="tabs_content_container no-padding">
<div class="for_seperator">
<div id="tab4" class="tab_content col-md-12" style="display: block;">
<div class="row"></div>
<?php PageContext::renderPostAction('plansnippet'); ?>
</div>
</div>

<div id="tab1" class="tab_content tab-bg">
...
<li id="jqSubDomainEntryBox" style="display:none;border-bottom:0px none;">
<div>
...
<div class="dom-txt2">
<input name="" type="text" class="width1" id="idsld1" name="sld1">
</div>
<div class="dom-btn">
...
http://www.</span></div>
<div class="dom-txt2">
<input name="" type="text" class="width1" id="idsld2" name="sld2">
</div>
<div class="dom-btn3">
...
<div class="proceed_content_box3" style="display:none; background: #fff; float: left; width: 100%;">
<form id="frmUsers" name="frmUsers" method="POST">
<input type="hidden" name="upgradeFlag" id="upgradeFlag" value="1">
...
<tr>
<td colspan="2" style="padding-bottom: 15px;"><h3>Please enter your billing info</h3></td>
</tr>
<tr>
<td align="left" width="32%" valign="center">First Name<span class="mandred">*</span> </td>
<td align="left"><input type="text" autocomplete="off" id="fname" name="fname" value="<?php echo $this->cardDetails->vFirstName ? $this->cardDetails->vFirstName : $this->fname; ?>" maxlength="255" ></td>
</tr>
<tr>
<td align="left" valign="center">Last Name<span class="mandred">*</span></td>
<td><input type="text" autocomplete="off" id="lname" name="lname" value="<?php echo $this->cardDetails->vLastName ? $this->cardDetails->vLastName : $this->lname; ?>" maxlength="255" ></td>
</tr>
<tr>
<td align="left" valign="center">Email<span class="mandred">*</span></td>
<td><input type="text" autocomplete="off" id="email" name="email" value="<?php echo $this->cardDetails->vEmail ? $this->cardDetails->vEmail : $this->email; ?>" maxlength="255" >
...
<td><input type="text" id="phone" name="phone" autocomplete="" value="<?php echo $this->cardDetails->vPhoneNumber ? $this->cardDetails->vPhoneNumber : PageContext::$response->phone; ?>" maxlength="255" ></td>

</tr>

<tr>
<td align="left" valign="center">Address<span class="mandred">*</span></td>
<td><input type="text" autocomplete="off" id="add1" name="add1" value="<?php echo $this->cardDetails->vAddress ? $this->cardDetails->vAddress : $this->address; ?>" maxlength="255" ></td>
</tr>
<tr>
<td align="left" valign="center">Country<span class="mandred">*</span></td>
<td>
<select name="country" id="country" onchange="checksubdomstatevalue(this.value);">
...
<tr id="subdom_non_us_states" style="display:none;">
<td align="left" valign="center">State<span class="mandred">*</span></td>
<td><input type="text" autocomplete="off" id="state" name="state" value="<?php echo $this->cardDetails->vState ? $this->cardDetails->vState : $this->state; ?>" maxlength="255"></td>
</tr>
<tr id="subdom_us_states">
<td align="left" valign="center">State<span class="mandred">*</span></td>
<td>
<select name="RegistrantState" id="RegistrantState" size="1" class="comm_input">
<?php
global $usStates;
...
<td><input type="text" autocomplete="off" id="city" name="city" value="<?php echo $this->cardDetails->vCity ? $this->cardDetails->vCity : $this->city; ?>" maxlength="255" ></td>
</tr>
<tr>
<td align="left" valign="center">ZIP<span class="mandred">*</span></td>
<td><input type="text" autocomplete="off" id="zip" name="zip" value="<?php echo $this->cardDetails->vZipcode ? $this->cardDetails->vZipcode : $this->zip; ?>" maxlength="10"></td>
</tr>                                                        
...
<input type="hidden" value="<?php echo $this->lookupid; ?>" id="productLookUpId_subdomain" name="productLookUpId_subdomain">
<input type="hidden" value="<?php echo $this->lookupid; ?>" name="idlookup" id="idlookup">
<input type="hidden" value="<?php echo PageContext::$response->stripesettings['SecretKey']; ?>" id="stripe_SecretKey" name="stripe_SecretKey">
<input type="hidden" value="<?php echo PageContext::$response->stripesettings['PublishKey']; ?>" id="stripe_publishkey" name="stripe_publishkey">
<input type="hidden" value="<?php echo PageContext::$response->SEmail; ?>" id="Semail" name="Semail">
...
<div class="small_new  right_text r_float_new"><h5><?php echo ADMIN_CURRENCY_SYMBOL;?><span class="jqSubTotal"><?php echo $this->planPrice; ?></span></h5></div>
<div class="clear"></div>
</div>
<div class="payment_right_item_new">
...
<div class="small_new  right_text r_float_new"><h5><?php echo ADMIN_CURRENCY_SYMBOL;?><span class="jqDiscount"><?php echo Utils::formatPrice(0); ?></span></h5></div>
<div class="clear"></div>
</div>
...
<td><input type="button" name="jqCoupon" onclick="couponCodeValidation('couponNumber2')" value="APPLY" class="button_orange2 btn-orng">
...
echo $this->planName;
?>
<td><img src="<?php echo BASE_URL; ?>project/styles/images/bluedog-logo.png"  title="BlueDog" onclick="showPaymentdiv('bluedog')" height="" width=""></td>
<?php
}
...
<input type="hidden" value="<?php echo $this->lookupid; ?>" id="productLookUpId_domain" name="productLookUpId_domain">
<input type="hidden" value="<?php echo $this->lookupid; ?>" name="productLookUpId" id="productLookUpId">
<input type="hidden" value="<?php echo $this->lookupid; ?>" name="idlookup" id="idlookup">
...
<td  align="left"><input name="RegistrantFirstName" id="RegistrantFirstName" type="text" autocomplete="off" class="comm_input" value="<?php echo $_POST["RegistrantFirstName"] ? $_POST["RegistrantFirstName"] : $this->cardDetails->vFirstName; ?>" style="width:230px; "> </td>
</tr>
<tr>
<td  align="left"  valign="center"> Last Name<span class="mandred">*</span></td>
<td align="left"><input name="RegistrantLastName" id="RegistrantLastName" type="text" autocomplete="off" class="comm_input" value="<?php echo $_POST["RegistrantLastName"] ? $_POST["RegistrantLastName"] : $this->cardDetails->vLastName; ?>" style="width:230px; "></td>
</tr>
<tr>
<td align="left"  valign="center">Email&nbsp;Address<span class="mandred">*</span></td>
<td align="left"><input name="RegistrantEmailAddress" id="RegistrantEmailAddress" type="text" autocomplete="off" class="comm_input" value="<?php echo $_POST["RegistrantEmailAddress"] ? $_POST["RegistrantEmailAddress"] : $this->cardDetails->vEmail; ?>" style="width:230px; "><span id="jqShowEmailAccountMessage" class="domainsearchfaild" style="display:none"> Account exists with email id.Please <a class="jqLoginInnerDiv" href="#">Login</a> to continue</span>
<input type="hidden" id="jqRegistrantAccountExistence" value="0"></td>
</tr>
<tr>
<td align="left"  valign="center" >Job<span class="mandred">*</span></td>
<td align="left"><input name="RegistrantJobTitle" id="RegistrantJobTitle" value="<?php echo $_POST["RegistrantJobTitle"]; ?>" type="text" autocomplete="off" class="comm_input" style="width:230px; "></td>
</tr>
<tr>
<td align="left"  valign="center">Organization&nbsp;Name<span class="mandred">*</span></td>
<td align="left"><input name="RegistrantOrganizationName" id="RegistrantOrganizationName" value="<?php echo $_POST["RegistrantOrganizationName"]; ?>" type="text" autocomplete="off" class="comm_input" style="width:230px; "></td>
</tr>
<tr>
<td align="left"  valign="center" >Address1<span class="mandred">*</span></td>
<td align="left"><input name="RegistrantAddress1" id="RegistrantAddress1" type="text" autocomplete="off" class="comm_input" value="<?php echo $_POST["RegistrantAddress1"] ? $_POST["RegistrantAddress1"] : $this->cardDetails->vAddress; ?>" style="width:230px; "></td>
</tr>
<tr>
<td align="left" valign="center" >Address2</td>
<td align="left"><input name="RegistrantAddress2" id="RegistrantAddress2" type="text" autocomplete="off" class="comm_input" value="<?php echo $_POST["RegistrantAddress2"]; ?>" style="width:230px; "></td>
</tr>
<tr>
<td align="left"  valign="center">Country<span class="mandred">*</span></td>
<td align="left"> 
...
<td align="left"><input  type="text" autocomplete="off" class="comm_input" name="RegistrantProvince" id="RegistrantProvince" maxlength="60"
                         value="<?php echo $strProvinceValue; ?>" style="width:230px; " checked="true"></td>
</tr>
<tr id="dom_us_na">
...
<tr>
<td align="left"  valign="center" >City<span class="mandred">*</span></td>
<td align="left"><input name="RegistrantCity" id="RegistrantCity" type="text" autocomplete="off" class="comm_input" value="<?php echo $_POST["RegistrantCity"] ? $_POST["RegistrantCity"] : $this->cardDetails->vCity; ?>" style="width:230px; "></td>
</tr>
<tr>
<td align="left"  valign="center">Postal/ZIP&nbsp;Code<span class="mandred">*</span></td>
<td align="left"><input name="RegistrantPostalCode" id="RegistrantPostalCode" autocomplete="off" value="<?php echo $_POST["RegistrantPostalCode"] ? $_POST["RegistrantPostalCode"] : $this->cardDetails->vZipcode; ?>" type="text" class="comm_input" style="width:230px; "></td>
</tr>                                                   
<tr>
<td align="left"  valign="center" >Fax</td>
<td align="left"><input name="RegistrantFax" id="RegistrantFax" type="text" autocomplete="off" class="comm_input" value="<?php echo $_POST["RegistrantFax"]; ?>" style="width:230px; "></td>
</tr>
<tr>
<td align="left"  valign="center" >Phone<span class="mandred">*</span></td>
<td align="left" width="73%"><input name="RegistrantPhone" id="RegistrantPhone" type="text" autocomplete="off" class="comm_input" value="<?php echo $_POST["RegistrantPhone"]; ?>" style="width:230px; "></td>
</tr>                                                    
<?php
//                                                  if($showUK) {
...
<input type="hidden" name="productId" value="<?php echo $this->planId; ?>" id="productId" class="productId">
<input type="hidden" name="productLookUpId" value="<?php echo $this->lookupid; ?>" id="productLookUpId" class="productLookUpId">
<input type="hidden" value="<?php echo $this->lookupid; ?>" name="idlookup" id="idlookup">
...
<div class="small_new  right_text r_float_new"><?php echo ADMIN_CURRENCY_SYMBOL;?><span class="jqSubTotal"><?php //echo $this->planPrice; ?></span></div>
<div class="clear"></div>
</div>
<div class="payment_right_item_new">
<div class="large_new l_float">&nbsp;</div>
...
<div class="small_new  right_text r_float_new"><h5><?php echo ADMIN_CURRENCY_SYMBOL;?><span class="jqTotalPurchaseVal"><?php Utils::formatPrice($this->planPrice); ?></span>&nbsp;</h5></div>
<div class="clear"></div>
</div>
</li>
...
$paymentCount++;
?>
<td><img src="<?php echo BASE_URL; ?>project/styles/images/bluedog-logo.png" height="" width="" title="BlueDog" onclick="showPaymentdiv('bluedogdomain')" style="margin-top: 15px;"></td>
<?php
}
echo PageContext::$response->planName;
if($paymentCount % 5 ==0)
echo '</tr><tr>';
?>
<?php
