        ...
        <li>
          ...
          <h3>Enter Card details</h3>
			...
			Card Number<span class="mandred">*</span>&nbsp;&nbsp;&nbsp;
                ...
                <div class="large l_float left_text">
                    <input type="text" id="ccno1_paypalpro" name="ccno1_paypalpro" maxlength="16" class="width1">
                </div>
                <div class="clear"></div>
            </div>
			...
			Expiry Date(MM/YYYY)<span class="mandred">*</span>&nbsp;&nbsp;&nbsp;
                ...
                <div class="large l_float left_text">
                    <select name="expM_paypalpro" id="expM1_paypalpro" class="width2">
                    ...
                    <select name="expY_paypalpro" id="expY1_paypalpro" class="width2">
         ...
         <!---   <input type="hidden" name="productId" value="<?php// echo $this->productid;?>" id="productId">-->
			...
			CVV/CVV2 No.<span class="mandred">*</span>&nbsp;&nbsp;&nbsp;
                ...
                <div class="large l_float left_text">
                    <input type="password" id="cvv1_paypalpro" name="cvv1_paypalpro" maxlength="4" class="width2">&nbsp;&nbsp;<!--<a href="#">Where do I find this?</a>-->
                </div>
                <div class="clear"></div>
            </div>
            <div class="payment_right_item">
