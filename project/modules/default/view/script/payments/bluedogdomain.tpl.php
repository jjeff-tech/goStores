        ...
        <li>
			...
			Card Number<span class="mandred">*</span>&nbsp;&nbsp;&nbsp;
                ...
                <div class="large l_float left_text">
                    <input type="text" id="ccno1_bluedogdomain" name="ccno1_authorize" maxlength="16" class="width1">
                </div>
                <div class="clear"></div>
            </div>
			...
			Expiry Date(MM/YYYY)<span class="mandred">*</span>&nbsp;&nbsp;&nbsp;
                ...
                <div class="large l_float left_text">
                    <select name="expM_authorize" id="expM1_bluedogdomain" class="width2">
                    ...
                    <select name="expY_authorize" id="expY1_bluedogdomain" class="width2">
			...
			CVV/CVV2 No.<span class="mandred">*</span>&nbsp;&nbsp;&nbsp;
                ...
                <div class="large l_float left_text">
                    <input type="password" id="cvv1_bluedogdomain" name="cvv1_authorize" maxlength="4" class="width2">&nbsp;&nbsp;<!--<a href="#">Where do I find this?</a>-->
                </div>
                <div class="clear"></div>
            </div>
            <div class="payment_right_item">
...
<input type="button" class="button_gray_big jqBackToDomain" name="back_btn" value="BACK" />
