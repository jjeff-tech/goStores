 ...
 <h3>Enter Card details</h3>
			...
			Card Number<span class="mandred">*</span>&nbsp;&nbsp;&nbsp;
                ...
                <div class="large l_float left_text">
                    <input type="text" id="ccno1_paypalflowdomain" name="ccno1_paypalflow" maxlength="16" class="width1">
                </div>
                <div class="clear"></div>
            </div>
			...
			Expiry Date(MM/YYYY)<span class="mandred">*</span>&nbsp;&nbsp;&nbsp;
                ...
                <div class="large l_float left_text">
                    <select name="expM_paypalflow" id="expM1_paypalflowdomain" class="width2">
                    ...
                    <select name="expY_paypalflow" id="expY1_paypalflowdomain" class="width2">
                        <?php
						$pyear	=	date("Y");
                                                $pyearvalue	=	date("y");
                                               	$nyr	=	$pyear + 25;
          ...
          <!--  <input type="hidden" name="productId" value="<?php// echo $this->productid;?>" id="productId">-->
			...
			CVV/CVV2 No.<span class="mandred">*</span>&nbsp;&nbsp;&nbsp;
                ...
                <div class="large l_float left_text">
                    <input type="text" id="cvv1_paypalflowdomain" name="cvv1_paypalflow" maxlength="4" class="width2">&nbsp;&nbsp;<!--<a href="#">Where do I find this?</a>-->
                </div>
                <div class="clear"></div>
            </div>
            <div class="payment_right_item">
