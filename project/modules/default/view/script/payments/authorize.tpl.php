        ...
        <li>
			...
			Card Number<span class="mandred">*</span>&nbsp;&nbsp;&nbsp;
                ...
                <div class="large l_float left_text">
                    <input type="text" id="ccno1_authorize" name="ccno1_authorize" maxlength="16" class="width1">
                </div>
                <div class="clear"></div>
            </div>
			...
			Expiry Date(MM/YYYY)<span class="mandred">*</span>&nbsp;&nbsp;&nbsp;
                ...
                <div class="large l_float left_text">
                    <select name="expM_authorize" id="expM1_authorize" class="width2">
                    ...
                    <select name="expY_authorize" id="expY1_authorize" class="width2">
			...
			CVV/CVV2 No.<span class="mandred">*</span>&nbsp;&nbsp;&nbsp;
                ...
                <div class="large l_float left_text">
                    <input type="password" id="cvv1_authorize" name="cvv1_authorize" maxlength="4" class="width2">&nbsp;&nbsp;<!--<a href="#">Where do I find this?</a>-->
                </div>
                <div class="clear"></div>
            </div>
            <div class="payment_right_item">
                ...
                <div class="large l_float left_text" style="width:auto;">
                    <input type="button" value="BACK" name="back_btn" class="button_gray_big jqBackToDomain">
