...
//        error_reporting(E_ALL);
        ...
        $userArray['front_end_url'] = "http://".$subdom.".".DOMAIN_NAME."/index.php";
        $userArray['back_end_url']  = "http://".$subdom.".".DOMAIN_NAME."/admins/";
...
*/
                 User::createSupportuser($dataArr['firstName'], $dataArr['password'], $dataArr['emailAddress']);
