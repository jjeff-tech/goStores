<div class="form_container">
    ...
    <div class="form_bgr">
        ...
        {
            ?>
        <form id="frmEmailSettings" action="<?php echo ConfigUrl::base(); ?>index/emailsettings" method="post" >
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="formstyle" id="id-form">
		...
		<tr>
		  <th align="left" valign="top" width="20%">Template Name <span class="mandred">*</span></th>
...
$this->messageFunction ='';?>
        ...
        <table width="95%"   border="0" align="center" cellpadding="0" cellspacing="0">
            <tr class="heading1">
                ...
                <td width="64%"  align="left">Template Name</td>
            ...
            <tr class="<?php echo $className ?>" id="item_<?php echo $row->cms_id;?>">
                ...
                <td align="left"><span class="edit"><a href="<?php echo ConfigUrl::base(); ?>index/emailsettings/edit/<?php echo $row->cms_id;?>" title="Edit" >Edit</a></span>
                </td>
            </tr>
