...
$("#jqNumYears").click(checkdomainavailability);
    ...
    $('#jqShowMessage').text('');
     $("#jqProductPayNow").validate({
                rules: {RegistrantFirstName: {required: true},
                    RegistrantEmailAddress: {required: true, email: true},
                    RegistrantLastName: {required: true} ,
                    RegistrantJobTitle: {required: true},
                    RegistrantOrganizationName: {required: true},
                    RegistrantAddress1: {required: true},
                    RegistrantCity: {required: true},
                    RegistrantPostalCode:{required: true},
                    RegistrantFax: {required: true},
                    RegistrantPhone: {required: true},
                    ccno2:{required: true},
                    cvv2:{required: true}
                ...
                messages: {RegistrantFirstName: {required: "Please enter first name"},
                    RegistrantEmailAddress: {required: "Please enter email", email:"Please enter a valid email"}	,
                    RegistrantLastName: {required: "Please enter last name"},
                    RegistrantJobTitle: {required: "Please enter job title"},
                    RegistrantOrganizationName: {required: "Please enter organization name"},
                    RegistrantAddress1: {required: "Please enter address"},
                    RegistrantCity: {required: "Please enter city"},
                    RegistrantPostalCode: {required: "Please enter postal/zip code"},
                    RegistrantFax: {required: "Please enter fax"},
                    RegistrantPhone: {required: "Please enter phone number"},
