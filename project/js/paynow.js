...
$(document).ready(function(){
    ...
    $("#jqProductPayNow").validate({
        ...
        messages: {
            RegistrantFirstName: {
                required: "Please enter first name",
                maxlength: "Maximum 30 characters are allowed for first name field"
            },
            RegistrantEmailAddress: {
                required: "Please enter email address", 
                email:"Please enter a valid email address",
                maxlength: "Maximum 80 characters are allowed for email field"
            }   ,
            RegistrantLastName: {
                required: "Please enter last name",
                maxlength: "Maximum 30 characters are allowed for last name field"
            },
            RegistrantJobTitle: {
            ...
            RegistrantOrganizationName: {
                ...
                maxlength: "Maximum 100 characters are allowed for organization field"
            },
            RegistrantAddress1: {
                required: "Please enter address",
                maxlength: "Maximum 41 characters are allowed for address1 field"
            },
            RegistrantAddress2: {                
                maxlength: "Maximum 41 characters are allowed for address2 field"
            },
            RegistrantCity: {
                required: "Please enter city",
                maxlength: "Maximum 30 characters are allowed for city field"
            },
            RegistrantPostalCode: {
                required: "Please enter zip/postal code",
                minlength: "Minimum 2 characters are needed for zip/postal code field",
                maxlength: "Maximum 10 characters are allowed for zip/postal code field"
            },
            RegistrantFax: {                
                maxlength: "Maximum 17 characters are allowed for fax field"
            },
            RegistrantPhone: {
                required: "Please enter phone number",
                maxlength: "Maximum 17 characters are allowed for phone field"
            },
            ccno2: {
...
function paynow(flag)
{
    ...
    if($("#jqUserExistFlag").val() ==1 && couponCodeValidation('couponNumber2')){
        ...
        if(currentPaymant=='bluedog'){
             var ecardNumber =  $("#ccno1_bluedog").val();
             var eyear      =  $("#expY1_bluedog").val();
             var emonth     =  $("#expM1_bluedog").val();
             var ecvv     =  $("#cvv1_bluedog").val();
...
{ 
    //alert("Function cretaedomain in paynow.js file");
    var ajaxSubmitOption    = {
        url      : createAccount,
...
function showPlansList(selectedTabId, flag)
{
    flag = flag || 0;
