...
//          $ShippingPackage = $ship->ShippingPackage;
    ...
    function CheckoutServer2ServerButton($url, $size="large", $variant=true,
      ...
      if ($this->variant == "text") {
        $data .= "<div align=\"center\" class=\"googlecheckout\"><form method=\"post\" action=\"".
    ...
    function CheckoutButtonCode($size="large", $variant=true, $loc="en_US",
      ...
      $data = "<div class=\"page_gcheck\"><div>";
      if ($this->variant == "text") {
      	$data .= "<body onLoad=\"document.forms['frmgoogglecheckout'].submit();\">\n";
      	$data .= "<center><h2>Please wait, your order is being processed and you";
      	$data .=" will be redirected to the Google website.</h2></center>\n";
        $data .= "<div align=\"center\" class=\"googlecheckout\"><form name=\"frmgoogglecheckout\" method=\"post\" action=\"".
