...
class Ogone{
    ...
    public function __construct()
    {
        ...
        $this->gatewayUrl = 'https://secure.ogone.com/ncol/prod/';
        $this->ipnLogFile = '';
        $this->passPhrase = '';
        $this->ogoneSha1 = '';
    }
    ...
    {
        $this->testMode = TRUE;
        $this->gatewayUrl = "https://secure.ogone.com/ncol/test/orderstandard.asp";
    }
   ...
   function submitPayment()
    ...
    function submitPaymentDisplay()
    {
       ...
       $paymentHtml.= "<form method=\"POST\" name=\"gateway_form\" ";
        ...
        $paymentHtml.= "<input name=\"SHASIGN\" type=\"hidden\" value=\"$this->Ogone_sha1\" />\n";
    ...
    function prepareSubmit()
    {
       ...
       $this->fields['AMOUNT'] = $this->fields['AMOUNT'] * 100;
       $this->getOgoneSha1();
    }
  ...
  //  abstract protected function validateIpn();
    ...
    function logResults($success)
    {
     ...
     function getOgoneSha1()
     {
         $passphrase = $this->passPhrase;
         $this->Ogone_sha1 = "ACCEPTURL=".$this->fields['ACCEPTURL'].$passphrase."AMOUNT=".$this->fields['AMOUNT'].$passphrase."CANCELURL=".$this->fields['CANCELURL'].$passphrase."CN=".$this->fields['CN'].$passphrase."CURRENCY=".$this->fields['CURRENCY'].$passphrase. "DECLINEURL=".$this->fields['DECLINEURL'].$passphrase."EMAIL=".$this->fields['EMAIL'].$passphrase."EXCEPTIONURL=".$this->fields['EXCEPTIONURL'].$passphrase."LANGUAGE=".$this->fields['LANGUAGE'].$passphrase. "LOGO=".$this->fields['LOGO'].$passphrase. "OPERATION=".$this->fields['OPERATION'].$passphrase."ORDERID=".$this->fields['ORDERID'].$passphrase."PSPID=".$this->fields['PSPID'].$passphrase;
	 $this->Ogone_sha1 = sha1($this->Ogone_sha1);
