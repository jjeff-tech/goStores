	...
	public function __construct($graphType, $width =450, $height=250)
        {
            ...
            if($graphType==1)
            {
               ...
               $this->FD->setSWFPath(BASE_URL."project/lib/fusioncharts/FusionCharts/");
        ...
        public function setChartParams($caption = 'caption', $formatNumberScale = 1, $rotateValues = 1, $decimalPrecision = 1, $numvDivLines = 5 ,$showPercentValues=0, $xAxisName='Month', $yAxisName='Count'){
             # Define chart attributes
             $strParam="caption=$caption;formatNumberScale=$formatNumberScale;xAxisName=$xAxisName;yAxisName=$yAxisName;rotateValues=$rotateValues;decimalPrecision=$decimalPrecision;numDivLines=$numvDivLines;yAxisMinValue=0;yAxisMaxValue=1;showPercentValues=$showPercentValues";
              # Set chart attributes
              $this->FD->setChartParams($strParam);
        }
