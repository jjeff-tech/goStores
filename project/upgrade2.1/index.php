...
$path_part[1] .= '/';
$path_part[1] = str_replace('project/upgrade2.1/', '', $path_part[1]);
...
if (isset($_POST['upgraderCheck'])) {
        ...
        if (isset($_POST["btnContinue"]) && !isset($_POST["auto_set"])) {
            ...
            if (trim($txtFTPpassword) == '') {
                ...
                if ($login_result) {
                    ...
                    $user_install = str_replace('upgrade2.1', '', getcwd());
    ...
    if ($error) {
        ...
        $configcontent .= "define('VERSION', '2.1'); \n\n";
        $configcontent .= "\n?>";
