<div class="section_list_view ">
    ...
    <div class="row have-margin">
        ...
        <span class="legend hdname hdblk_inr">
            <?php if(PageContext::$response->parentSectionName!="") {
                echo "<div class='hdblk_inr'>Section : ".PageContext::$response->parentSectionName." [".PageContext::$response->parentBreadCrumbName."] &raquo; Subsection: ".PageContext::$response->sectionData->section_name."</div>";
                ?>
            ...
            <tr id="jqRecord_<?php echo $record->$parentKey;?>">
                ...
                <td><?php if($colType   ==  "file") {
                                ...
                                if(PageContext::$response->columns->$col->externalNavigation || PageContext::$response->columns->$col->customColumn )
                                    ...
                                    echo substr(strip_tags($record->$col),0,80);
                            }  ?></td>
                        <?php  }
                ...
                <td>
                    ...
                    <a data-toggle="modal" href="#<?php echo $record->$parentKey?>"><img class="table_iconset_2 li_iconset  " src="<?php  echo BASE_URL?>modules/cms/images/details_icon.png"></a>
                            <?php } ?>
                        <?php if(PageContext::$response->editAction) { ?>
                    <a class="cms_list_operation action_edit jqEditRecord" id="jqEditRecord_<?php echo $record->$parentKey?>" href="<?php echo  pageContext::$response->currentURL;?>&action=edit&<?php echo $parentKey;?>=<?php echo $record->$parentKey?>#addForm"><img class="<?php if(PageContext::$response->viewAction) { ?>table_iconset <?php } else { ?> table_iconset_2<?php } ?>li_iconset" src="<?php  echo BASE_URL?>modules/cms/images/edit_icon.png"></a>
                            <?php } ?>
                        <?php if(PageContext::$response->deleteAction) { ?>
                    <a class="cms_list_operation action_delete" href="<?php echo  PageContext::$response->currentURL;?>&action=delete&<?php echo $parentKey;?>=<?php echo $record->$parentKey?>"><img class="<?php if(PageContext::$response->viewAction || PageContext::$response->editAction ) { ?>table_iconset <?php } else { ?> table_iconset_2<?php } ?> li_iconset" src="<?php  echo BASE_URL?>modules/cms/images/delete_icon.png"></a>
                            <?php } ?>
...
<?php if(PageContext::$response->addAction) { ?>
            ...
            <a <?php if(PageContext::$response->displayFormMethod=="popup") { ?>  data-toggle="modal"  href="#addForm" <?php } else { ?> href="<?php echo  PageContext::$response->currentURL;?>&action=add#addForm" <?php } ?> class="addrecord btn btn-info">Add Record</a>
                <?php } ?>
<?php if( PageContext::$response->section_config->report) { ?>
            &nbsp;<a data-toggle="modal" href="#report" class="btn btn-info export">Export</a>&nbsp;
    <?php } ?>
        </div>
