...
class Filehandler{
    ...
    public 	$errors = array();
    protected 	$table = FILE_UPLOAD_TABLE;
...
//        }
       $file_play_time = ($file->file_play_time)?$file->file_play_time:0;
       $created_by = ($created_by)?$file->file_play_time:0;
